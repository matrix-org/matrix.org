...
> 🇫🇷 Very excited to announce that [DINUM, the French Interministerial Digital Directorate, is joining The Matrix.org Foundation](https://www.numerique.gouv.fr/sinformer/espace-presse/dinum-soutien-fondation-matrixorg/) as a [Silver member](@/foundation/members/index.md) and becomes the first government to join the Foundation! 🚀
>
...
>
> - New localizations: Japanese (thanks to [@shirahara:etke.cc](https://matrix.to/#/@shirahara:etke.cc)) and Ukrainian (thanks to [khvalera](https://github.com/khvalera))
