...
### NeoBoard Standalone ([website](https://github.com/nordeck/matrix-neoboard))
...
> Reminder that the first Matrix Stammtisch Aachen is taking place Monday evening! It's an informal gathering for people who are interested in exchanging their experiences with Matrix on all levels. Read more at <https://ccc.ac/post/2025-10-30-matrix-stammtisch> and if interested join the chatroom at [#matrix-stammtisch:ccc.ac](https://matrix.to/#/#matrix-stammtisch:ccc.ac)!
