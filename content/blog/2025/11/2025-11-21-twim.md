...
> 
> You can find the new room at the same location as before <https://matrix.to/#/#twim:matrix.org>
...
> `v0.5.0-rc.8`. **There are no new features in this release** (aside from advertised support for MSC4155, so you can now disable invites in Element without needing to manually edit your account data), as all of these changes were backported from the main branch. If you want shiny new toys, join #main:continuwuity.org and track the `main` branch! Plenty of cool pebbles and shiny gems there.
> 
> #### Bug fixes
> 
