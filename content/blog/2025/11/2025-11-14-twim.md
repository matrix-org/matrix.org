...
> 
> Back in early September, the room directory working group started an initial [beta test run](@/blog/2025/09/2025-09-12-twim.md#dept-of-trust-safety-scales). For the first time in months, it was possible again to get new rooms into the directory.
> 
...
> 
> There is now a dedicated subpage for the room directory on the matrix.org homepage [—you can find it here—](@/homeserver/room-directory.md) where users can easily access all relevant info. Please share it around!
> 
