...
> 
> Back in early September, the room directory working group started an initial [beta test run](https://matrix.org/blog/2025/09/12/this-week-in-matrix-2025-09-12/#dept-of-trust-safety-scales). For the first time in months, it was possible again to get new rooms into the directory.
> 
...
> 
> There is now a dedicated subpage for the room directory on the matrix.org homepage [—you can find it here—](https://matrix.org/homeserver/room-directory/) where users can easily access all relevant info. Please share it around!
> 
...
> 
> It's our very first edition - expect the two matrix admins of matrix.freiburg.social to be there: [@fx:yatrix.org](https://matrix.to/#/@fx:yatrix.org) and [@stereo:gnubox.club](https://matrix.to/#/@stereo:gnubox.club) and as special guest [Michael Muench](https://matrix.to/#/@michaelmicheal:matrix.org) 👋  
