...
> As part of my work for the Trust and Safety Committee I am trying to establish a working group to help with researching and documenting the state of T&S accross the ecosystem. If that sounds interesting to you, please poke your head into [#governing-board-office:matrix.org](https://matrix.to/#/#governing-board-office:matrix.org) and tell us!
> 
