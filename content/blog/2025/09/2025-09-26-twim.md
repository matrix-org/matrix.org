...
> 
> Of course that's only the big news. For the rest, check our [commitlog](https://github.com/matrix-org/matrix.org/commits/main/) or follow the Hookshot announcements in our public room [#matrix.org-website:matrix.org](https://matrix.to/#/#matrix.org-website:matrix.org)!
...
> [matrix-reminder-bot v0.4.0](https://github.com/anoadragon453/matrix-reminder-bot/releases/tag/v0.4.0) has been simmering for a while. Rather than features, it brings some quality of life improvements to existing features.
> 
