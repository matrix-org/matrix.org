...
> 
> Does your community use Matrix? Or do you maintain a community project that builds on Matrix? [Join the Foundation as a member](@/foundation/membership/index.md)! This helps us demonstrate the breadth of the ecosystem, and all members are entitled to participate in our [Governing Board](@/foundation/governing-board/index.md) elections.
