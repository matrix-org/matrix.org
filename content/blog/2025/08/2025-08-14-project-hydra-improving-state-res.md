...
We are not aware of these issues being exploited, but would recommend servers to upgrade immediately if they are operating rooms with users participating from untrusted servers, as per [Monday’s announcement](@/blog/2025/08/2025-08-11-security-prerelease.md). Room admins should then upgrade such rooms to version 12 to guard against these attacks in future - see the [new room upgrade guide](@/docs/communities/administration/_index.md#room-upgrades).
