...
>
> A bug has been fixed where room keys would be rotated unecessarily in the presence of blacklisted/withheld devices, with [#4954](https://github.com/matrix-org/matrix-rust-sdk/pull/4954).
>
> #### Media
>
