...
To add your update to the next edition, drop a message prefixed by a mention to the user `TWIM` in the above room, and it will be picked up. For images, please also mark them with a ⭕️ reaction.
