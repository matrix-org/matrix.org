...
> Ultimately, I will try in the following weeks to clarify the MSCs, and update areweoidcyet.com accordingly, but those things take time, and I can't clarify everything at once right now.
>
...
>
> - Some unfinished work regarding to authenticated media has happened on the dev/authenticated-media branch. This is very unfinished, but deprecates non-auth'd media routes, instead using them as fallbacks in auth-media-targetted functions.
