...
> 
> First of all we sent out a call to update the translations. Apparently that was quite successfull, there are like 20 commits with translation updates from the last 2 days now... If you find your language to be out of date, don't hesitate to jump on <https://weblate.nheko.im/projects/nheko/nheko-master/> to fix it.
> 
...
> * [Completed our montly notification placeholder rotation dance](https://github.com/element-hq/element-x-ios/pull/2298)
