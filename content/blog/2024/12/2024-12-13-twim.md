...
>
> ![A screenshot showcasing the UI to add a room to a space. It shows a list of rooms which can be selected or unselected with a done and apply button at the bottom right of the dialog shown.](/blog/img/pnnTbaVXlnfuFISaOvQBLVeA.png)
...
> ![A Meme of a person in a suit selling a car and another person listening. Both standing in front of said car. The Seller is labeled "Aine" while the customer is labeled "TWIM". The meme says "*Slaps roof of synapse admin* This bad boy can fit so many features in it"](/blog/img/synapse-admin-meme.png)
...
>
> ![A screenshot showing the results of sending a tidal link to the room and a reply of maubot showing the alternative sources for said song.](/blog/img/UInzDHOSlVdCEQTUXFIWIUad.png)
...
>
> ![A screenshot of the new UI which replaces the d3-dag implementation. It is easier to read and cleaner.](/blog/img/ozPYslrUfnMjcKfOwHFpGjPt.png)
>
