...
> * new translations for bulgarian swedish and ukranian have been added, and will soon be included in the next releases
...
> 
> ### New features
> * Filter uploads now allow `@me` (litteral) in `senders`/`not_senders`, these will be subtituted by the current user's MXID. This allows far easier templating.
> 
...
> * Rewrote outgoing http requests logic - fixed edge cases with odd context cancelations, added retrier for 5xx responses
> 
