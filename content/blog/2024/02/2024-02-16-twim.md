...
>   * Automatic Postgres database tuning (based on [PGTune](https://pgtune.leopard.in.ua/)'s calculation logic) which takes into account your server's configuration and installed components
