...
> * This week we've released version 0.6.4 to Google Play Open Testing. Message
>   Pinning is now stable - long press on a message and tap Pin to try it out
>   yourself!
> * We have spend most of our time fixing bugs and improving code, including
>   tests.
> * Finally we’re tackling the AGPL migration on various projects to be inline
>   with all of our Element licenses.
