...
>
> {{figure(img="/blog/img/governing_board.avif", caption="The Governing Board")}}
...
> {{figure(img="/blog/img/IMG_1747.avif", caption="The Matrix Conference 2024")}}
> {{figure(img="/blog/img/IMG_1993-2.avif", caption="Thank you to everyone!")}}
> </div>
...
> {{figure(img="/blog/img/IMG_2452-2.avif", caption="An MSC being written live at the Matrix Conference 2024")}}
...
>
> {{figure(img="/blog/img/WyTtlIKmJFJzBpCAfyugeBDh.avif", caption="The new interface for locations in Matrix Wrench")}}
