...
<br /><a href="https://matrix.to/#/@Half-Shot:half-shot.uk">Half-Shot</a> will only be working full time with the Matrix Core team for another week (!!!), but until then he's going full-speed with bridge work. First <a href="https://github.com/matrix-org/matrix-appservice-irc">matrix-appservice-irc</a>:
