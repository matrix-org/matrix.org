...
<iframe width="1280" height="720" src="https://www.youtube.com/embed/Vq_v_C6HE84" frameBorder="0" allow="autoplay; encrypted-media" allowFullScreen></iframe>
...
<a href="https://matrix.to/#/@MTRNord:matrix.ffslfl.net">MTRNord</a> introduced us to <a href="https://git.nordgedanken.de/Nordgedanken/SimpleMatrix">SimpleMatrix</a>:<br /><blockquote>SimpleMatrix is my approach on making an Android App that is more easy to use than the official one in Terms of UX and UI. Planned is also a Android Wear App within this App for mostly Notifications.</blockquote>
