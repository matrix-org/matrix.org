...
>   groups
> * **Planned**: Use Matrix's End-to-End encryption to ensure the secure
>   transmission and storage of highlight data.
> * **Planned**: Leverage the new [m.thread
>   MSC](https://github.com/matrix-org/matrix-doc/blob/gsouquet/threading-via-relations/proposals/3440-threading-via-relations.md)
>   to allow users to comment on and discuss highlights.
> * **Planned**: Use something like [ArchiveBox](https://archivebox.io/) to
