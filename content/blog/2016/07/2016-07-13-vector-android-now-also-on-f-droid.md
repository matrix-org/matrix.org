...
<img src="/blog/wp-content/uploads/2016/07/V.png" alt="Vector" width="20%" height="20%" class="alignleft size-full" /> Vector Android has been added to the <a href="https://f-droid.org/repository/browse/?fdid=im.vector.alpha">F-Droid catalogue</a>. F-Droid is an installable catalogue of FOSS (Free and Open Source Software) applications for the Android platform. Many people have asked or requested Vector to be added to F-Droid, so we are happy to be able to announce its inclusion.
