...
> 
> * Use the included Matrix bot to automatically sync RSVP emoji reactions in a
>   linked Matrix room (great for your friends on Matrix or in a bridged Signal
>   chat)
> * Send a unique one-click RSVP links to you friends without Matrix (eg.
>   Instagram DMs, SMS)
> * And as of this week, guests can "self serve" and add their own RSVP via the
>   unique event link, so you can just drop the event link in a Facebook
>   Messenger chat or iMessage group (without email or phone verification at
>   the moment, so hosts will need to moderate if their guests go rogue and add
>   multiple fake names!)
> 
