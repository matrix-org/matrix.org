...
>
> Hiding joins works with room v9 restricted join rules feature to allow IRC ghosts to join rooms without an invite from the bridge bot first. This clears some clutter and may even make joining a bit faster in the long run - we will see. This feature is disabled by default and needs to be enabled by the bridge administrator as it is considered a "labs" feature for now.
>
