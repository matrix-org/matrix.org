...
> - Deeper platform integration: recent rooms accesible from the taskbar (windows), full menu bar shortcut coverage / spotlight search (mac), GNOME Shell/KRunner room search.
> - Room knocking
