...
[extra]
image = "https://matrix.org/blog/img/MatrixLiveS12E01.png"
+++
...
> 
> 
> If you like to propose a session please use our session scheduler or drop a note in our [hedgedoc](https://hedgedoc.sosnowkadub.de/QUR_1ZUNSRS0OBrJ2EiFdg#).
...
A (new) Matrix Home Server (forked from Dendrite, Go-based).

[pat-s](https://matrix.to/#/@pat-s:matrix.devxy.io) reports
