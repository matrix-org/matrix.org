...
### Welcoming Pangea Chat as a new Silver member!

[Amandine](https://matrix.to/#/@Amandine:matrix.org) announces

> Welcoming [Pangea Chat](https://pangea.chat/) as the newest Silver member of the Foundation! Pangea uses Matrix as the basis for their language learning via instant messaging app 🌍️ We love being part of an initiative spreading knowledge and build links between people 👏
...
### Continuwuity 0.5.6 ([website](https://continuwuity.org/))
...
### Commet v0.4.1 ([website](https://commet.chat))
