...
> - User read receipts are now shown next to the lastest message each user has seen.
...
> #### Resources
>
> More information on the [Github repository](https://github.com/vrisalab/matrix-simple-invite). You can freely use [my instance](https://msi.vtubeando.net/). You can test the invitee experience by joining the oficial channel #msi:vtubeando.net  with [this invite link](https://msi.vtubeando.net/gg?id=ea5fdb34)!
>
> #### Screenshots
>
