...
> 
> Not too much exciting news otherwise. As always, take a look at [The View](https://github.com/orgs/matrix-org/projects/100) to see the Spec Core Team's current priorities. And if you have an MSC that you think is ready for the SCT to take a look at, let us know in #sct-office:matrix.org!
...
> As always, feel free to stop by #synapse:matrix.org to join in on the discussion and if you encounter a bug make sure to report it [here](https://github.com/element-hq/synapse/issues/new/choose).
...
> 
> Bots which aren't using encryption *should* be able to upgrade right away. Let me know in #matrix-bot-sdk:t2bot.io if that turns out to be untrue 😅
> 
...
> 
> The full changelog is [available on github](https://github.com/turt2live/matrix-bot-sdk/releases/tag/v0.8.0), and best effort support can be found in the freshly upgraded #matrix-bot-sdk:t2bot.io room. Hopefully the next release is a bit sooner than 2 years from now 😅
