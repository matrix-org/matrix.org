...
> [m] Join us in [#fosdem-2026-hackathon:matrix.org](https://matrix.to/#/#fosdem-2026-hackathon:matrix.org) to stay informed!
> 
> #### Booth
> 
...
> 
> As of today (2025-12-25), `11938` Matrix federateable servers have been discovered by matrixrooms.info, `3244` (`27.2%`) of them are publishing their rooms directory over federation.
> The published directories contain `16807` rooms.
> 
> The most popular server software among the online servers is:
> - synapse: `10207` (`85.5%`)
> - conduit: `468` (`3.9%`)
> - dendrite: `360` (`3.0%`)
> - continuwuity: `338` (`2.8%`)
> 
