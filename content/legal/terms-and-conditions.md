...
* Act in a way that is in violation of our [Code of Conduct](/legal/code-of-conduct/) in rooms that are part of the Matrix community ([+matrix:matrix.org](https://matrix.to/#/+matrix:matrix.org)).
