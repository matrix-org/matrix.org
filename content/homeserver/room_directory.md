...
2. Rooms or spaces may be included in the room directory if they meet the following criteria.
   ...
   4. Rooms named after a recognizable organization or project must be sponsored by that project or be clearly marked as unofficial, while still having a positive relationship with the project.
...
5. Matrix foundation staff may remove rooms from the room directory if they are found to be in violation of the code of conduct or this policy, or if removal is required to mitigate an ongoing incident.
