...
<div class="overscroll">
  <table class="legacy-table width-100">
    <thead>
      <tr>
        <th> </th>
        <th>Riot Web</th>
...
<p class="mxP"><em>These features are in common usage in the Matrix ecosystem and could be added to a future version of the spec.</em></p>
