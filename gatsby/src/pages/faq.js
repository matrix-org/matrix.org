...
const Faq = ({data}) => {
  function getSection(section) {
    ...
    <h2 id="intro"><a className="permalink" href="#intro" aria-hidden="true">&#128279;</a> Intro</h2>
<h3 id="basics"><a className="permalink" href="#basics" aria-hidden="true">&#128279;</a> Basics</h3>
...
<div className="question">
<h4 id="what-is-matrix's-mission%3F"><a className="permalink" href="#what-is-matrix's-mission%3F" aria-hidden="true">&#128279;</a> What is Matrix's Mission?</h4>
...
<div className="question">
<h4 id="what-does-this-mean-for-users%3F"><a className="permalink" href="#what-does-this-mean-for-users%3F" aria-hidden="true">&#128279;</a> What does this mean for users?</h4>
...
<div className="question">
<h4 id="why-are-you-called-matrix%3F"><a className="permalink" href="#why-are-you-called-matrix%3F" aria-hidden="true">&#128279;</a> Why are you called Matrix?</h4>
<p>We are called Matrix because we provide a structure in which all communication can be <a href="#definitions">matrixed together</a>.</p>
...
<p>In mathematics, a matrix is a lattice-like arrangement, in which expressions can be combined and treated as a single entity</p>
</div>
<div className="definition-close">close</div>
</div>
</div>
<div className="question">
<h4 id="what-does-matrix-provide%3F"><a className="permalink" href="#what-does-matrix-provide%3F" aria-hidden="true">&#128279;</a> What does Matrix provide?</h4>
<ul>
...
<p>You can find the full list of Matrix enabled projects at <a href="/blog/try-matrix-now">https://matrix.org/blog/try-matrix-now</a>.</p>
<div className="definition-list">
<div className="definition-item definition-clientsdk">
<p><strong>client SDK</strong></p>
<p>A client SDK makes it easier to develop client applications using matrix. See: <a href="#how-do-i-matrix-enable-my-existing-app%3F">How do I Matrix-enable my existing app?</a></p>
...
<p>We believe that any open standard defining interoperable communication needs to be justified, demonstrated and validated with transparent open source implementations. For Matrix to achieve its mission of making all communications services <a href="#definitions">interoperable</a> we believe it needs to be truly open, giving people access to take all the code we produce and to use and build on top of it.</p>
<div className="definition-list">
...
<div className="question">
<h4 id="what-do-you-mean-by-open%3F"><a className="permalink" href="#what-do-you-mean-by-open%3F" aria-hidden="true">&#128279;</a> What do you mean by open?</h4>
<p>Matrix is an open standard, meaning that we have freely published the
details for how to communicate <a href="#definitions">interoperably</a> using the Matrix set of
...
<div className="question">
<h4 id="what-does-federated-mean%3F"><a className="permalink" href="#what-does-federated-mean%3F" aria-hidden="true">&#128279;</a> What does federated mean?</h4>
...
<p><a href="#definitions">interoperable</a> clients
...
<div className="question">
<h4 id="how-is-this-like-e-mail%3F"><a className="permalink" href="#how-is-this-like-e-mail%3F" aria-hidden="true">&#128279;</a> How is this like e-mail?</h4>
<p>The <a href="https://en.wikipedia.org/wiki/History_of_email">History of email</a> is instructive when thinking about the importance of <a href="#definitions">interoperability</a>.</p>
...
<div className="question">
<h4 id="why-has-no-one-done-this-before%3F"><a className="permalink" href="#why-has-no-one-done-this-before%3F" aria-hidden="true">&#128279;</a> Why has no one done this before?</h4>
<p>There have been several attempts before including <a href="#definitions">RCS</a>.</p>
...
<p><a href="https://en.wikipedia.org/wiki/Rich_Communication_Services">Rich Communication Services</a> is a communication protocol between mobile-telephone carriers and between phone and carrier, aiming at replacing SMS messages with a text-message system that is richer, provides phonebook polling (for service discovery), and transmit in-call multimedia.</p>
</div>
<div className="definition-close">close</div>
</div>
</div>
<h3 id="practical"><a className="permalink" href="#practical" aria-hidden="true">&#128279;</a> Practical</h3>
<div className="question">
<h4 id="what-can-i-actually-do-with-this%3F"><a className="permalink" href="#what-can-i-actually-do-with-this%3F" aria-hidden="true">&#128279;</a> What can I actually do with this?</h4>
...
<div className="question">
<h4 id="how-can-i-get-involved%3F"><a className="permalink" href="#how-can-i-get-involved%3F" aria-hidden="true">&#128279;</a> How can I get involved?</h4>
...
<p>The Matrix Specification describes the interactions between actors in the Matrix ecosystem, including Server-Server and Client-Server. <a href="/docs/spec/">You can see the spec here.</a></p>
</div>
<div className="definition-item definition-client">
<p><strong>Client</strong></p>
<p>Users in Matrix use one or more clients to communicate. This could be any combination of a web client, a command line client, a mobile client - or embedded clients built into existing apps. It could even be a piece of hardware (e.g. a drone) that is Matrix enabled.</p>
...
<div className="question">
<h4 id="where-can-i-get-support%3F"><a className="permalink" href="#where-can-i-get-support%3F" aria-hidden="true">&#128279;</a> Where can I get support?</h4>
...
<div className="question">
<h4 id="how-do-i-create-a-link-to-a-matrix-room-or-user%3F"><a className="permalink" href="#how-do-i-create-a-link-to-a-matrix-room-or-user%3F" aria-hidden="true">&#128279;</a> How do I create a link to a Matrix room or user?</h4>
...
<h2 id="usage"><a className="permalink" href="#usage" aria-hidden="true">&#128279;</a> Usage</h2>
<h3 id="as-a-user"><a className="permalink" href="#as-a-user" aria-hidden="true">&#128279;</a> As a user</h3>
<div className="question">
<h4 id="what-clients-are-available%3F"><a className="permalink" href="#what-clients-are-available%3F" aria-hidden="true">&#128279;</a> What clients are available?</h4>
...
<p>A thorough list of clients can be found on the <a href="/blog/try-matrix-now">try-matrix-now</a> page.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
</div>
...
<div className="question">
<h4 id="where-can-i-find-a-mobile-app%3F"><a className="permalink" href="#where-can-i-find-a-mobile-app%3F" aria-hidden="true">&#128279;</a> Where can I find a mobile app?</h4>
...
<div className="question">
<h4 id="i-installed-riot-via-f-droid%2C-why-is-it-draining-my-battery%3F"><a className="permalink" href="#i-installed-riot-via-f-droid%2C-why-is-it-draining-my-battery%3F" aria-hidden="true">&#128279;</a> I installed Riot via F-Droid, why is it draining my battery?</h4>
...
<div className="question">
<h4 id="where-can-i-find-a-web-app%3F"><a className="permalink" href="#where-can-i-find-a-web-app%3F" aria-hidden="true">&#128279;</a> Where can I find a web app?</h4>
<p>See also: <a href="#what-clients-are-available%3F">What clients are available?</a></p>
<h5 id="riot"><a className="permalink" href="#riot" aria-hidden="true">&#128279;</a> Riot</h5>
...
<h5 id="neo"><a className="permalink" href="#neo" aria-hidden="true">&#128279;</a> neo</h5>
...
<div className="question">
<h4 id="where-can-i-find-a-desktop-client%3F"><a className="permalink" href="#where-can-i-find-a-desktop-client%3F" aria-hidden="true">&#128279;</a> Where can I find a desktop client?</h4>
<p>See also: <a href="#what-clients-are-available%3F">What clients are available?</a></p>
...
<div className="question">
<h4 id="how-can-i-get-a-rooms-list-from-matrix.org%3F"><a className="permalink" href="#how-can-i-get-a-rooms-list-from-matrix.org%3F" aria-hidden="true">&#128279;</a> How can I get a rooms list from matrix.org?</h4>
...
<p>There are even <a href="/docs/projects/try-matrix-now.html#client-sdks">more client SDKs available</a>.</p>
<p>Pick the one for your platform, or a 3rd party one if none of the above work for you,
and get plugging it in.  You'll probably also want to read the <a href="/docs/howtos/client-server.html">Client-Server API
HOWTO</a> too.</p>
...
from the list at <a href="/blog/try-matrix-now">https://matrix.org/blog/try-matrix-now</a>.
...
<div className="question">
<h4 id="how-can-i-write-a-client-on-matrix%3F"><a className="permalink" href="#how-can-i-write-a-client-on-matrix%3F" aria-hidden="true">&#128279;</a> How can I write a client on Matrix?</h4>
<p>See the <a href="/docs/howtos/client-server.html">Client-Server API
...
<div className="question">
<h4 id="how-do-i-register-custom-matrix-event-types%3F"><a className="permalink" href="#how-do-i-register-custom-matrix-event-types%3F" aria-hidden="true">&#128279;</a> How do I register custom matrix event types?</h4>
...
<div className="question">
<h4 id="can-i-write-a-matrix-homeserver%3F"><a className="permalink" href="#can-i-write-a-matrix-homeserver%3F" aria-hidden="true">&#128279;</a> Can I write a Matrix homeserver?</h4>
...
<div className="question">
<h4 id="why-http%3F-doesn't-http-suck%3F-why-don't-you-use-websockets%2Fcoap%2Fhttp2%2Fetc%3F"><a className="permalink" href="#why-http%3F-doesn't-http-suck%3F-why-don't-you-use-websockets%2Fcoap%2Fhttp2%2Fetc%3F" aria-hidden="true">&#128279;</a> Why HTTP? Doesn't HTTP suck? Why don't you use websockets/CoAP/HTTP2/etc?</h4>
...
<p>For these reasons it has been chosen as the mandatory baseline of the exchange, but it is still entirely possible to use other protocols for communication between clients and server (see for example this <a href="https://github.com/matrix-org/matrix-doc/issues/1148">websocket transport spec proposal</a>), and it's also possible in the future that negotiation of more efficient protocols will be added for the <a href="#definitions">federation</a> between servers, with HTTP+JSON remaining as the compatibility baseline.</p>
<div className="definition-list">
<div className="definition-item definition-federation">
<p><strong>federation</strong></p>
<p>Federation means that separate instances of a service communicate - the best example of this is email servers, in which it's possible to send mail between difference service providers. For Matrix, this means that data about rooms and message history is shared between servers of participating users.</p>
...
<h3 id="self-hosting"><a className="permalink" href="#self-hosting" aria-hidden="true">&#128279;</a> Self-hosting</h3>
<div className="question">
<h4 id="how-do-i-join-the-global-matrix-federation%3F"><a className="permalink" href="#how-do-i-join-the-global-matrix-federation%3F" aria-hidden="true">&#128279;</a> How do I join the global Matrix federation?</h4>
...
<div className="question">
<h4 id="how-do-i-run-my-own-homeserver%3F"><a className="permalink" href="#how-do-i-run-my-own-homeserver%3F" aria-hidden="true">&#128279;</a> How do I run my own homeserver?</h4>
...
<div className="question">
<h4 id="what-ports-do-i-have-to-open-up-to-join-the-global-matrix-federation%3F"><a className="permalink" href="#what-ports-do-i-have-to-open-up-to-join-the-global-matrix-federation%3F" aria-hidden="true">&#128279;</a> What ports do I have to open up to join the global Matrix federation?</h4>
...
<div className="question">
<h4 id="how-do-i-connect-my-homeserver-to-the-public-matrix-network%3F"><a className="permalink" href="#how-do-i-connect-my-homeserver-to-the-public-matrix-network%3F" aria-hidden="true">&#128279;</a> How do I connect my homeserver to the public Matrix network?</h4>
...
<div className="question">
<h4 id="can-i-run-my-own-identity-server%3F"><a className="permalink" href="#can-i-run-my-own-identity-server%3F" aria-hidden="true">&#128279;</a> Can I run my own identity server?</h4>
...
<div className="question">
<h4 id="why-can't-i-rename-my-homeserver%3F"><a className="permalink" href="#why-can't-i-rename-my-homeserver%3F" aria-hidden="true">&#128279;</a> Why can't I rename my homeserver?</h4>
<p>Currently, the <a href="#definitions">homeserver</a> name is assumed never to change. This means that if you rename your server, other servers will think it's a different server.</p>
...
<div className="question">
<h4 id="why-do-you-think-existing-apps-will-ever-join-this-officially%3F"><a className="permalink" href="#why-do-you-think-existing-apps-will-ever-join-this-officially%3F" aria-hidden="true">&#128279;</a> Why do you think existing apps will ever join this officially?</h4>
<p>We firmly believe it is what is right for the consumer. As people begin
to use <a href="#definitions">interoperable</a> communications tools, service providers will see the
...
<div className="question">
<h4 id="why-aren't-you-doing-this-through-the-ietf%3F-or-w3c%3F-or-3gpp%3F"><a className="permalink" href="#why-aren't-you-doing-this-through-the-ietf%3F-or-w3c%3F-or-3gpp%3F" aria-hidden="true">&#128279;</a> Why aren't you doing this through the IETF? or W3C? or 3GPP?</h4>
...
<h3 id="comparisons"><a className="permalink" href="#comparisons" aria-hidden="true">&#128279;</a> Comparisons</h3>
<div className="question">
<h4 id="what-is-the-difference-between-matrix-and-irc%3F"><a className="permalink" href="#what-is-the-difference-between-matrix-and-irc%3F" aria-hidden="true">&#128279;</a> What is the difference between Matrix and IRC?</h4>
...
<li>No open <a href="#definitions">federation</a></li>
...
<div className="question">
<h4 id="what-is-the-difference-between-matrix-and-xmpp%3F"><a className="permalink" href="#what-is-the-difference-between-matrix-and-xmpp%3F" aria-hidden="true">&#128279;</a> What is the difference between Matrix and XMPP?</h4>
<p>We think of Matrix and <a href="#definitions">XMPP</a> as being quite different; at its core
Matrix can be thought of as an eventually consistent global JSON db with
an HTTP API and <a href="#definitions">pubsub</a> semantics - whilst XMPP can be thought of as a
...
<div className="question">
<h4 id="how-does-matrix-compare-with-something-like-trillian-or-pidgin%3F"><a className="permalink" href="#how-does-matrix-compare-with-something-like-trillian-or-pidgin%3F" aria-hidden="true">&#128279;</a> How does Matrix compare with something like Trillian or Pidgin?</h4>
...
<h3 id="more-detail"><a className="permalink" href="#more-detail" aria-hidden="true">&#128279;</a> More Detail</h3>
<div className="question">
<h4 id="what-is-a-client%3F"><a className="permalink" href="#what-is-a-client%3F" aria-hidden="true">&#128279;</a> What is a client?</h4>
<p>Users in Matrix use one or more clients to communicate. This could be any combination of a web client, a command line client, a mobile client - or embedded clients built into existing apps.  It could even be a piece of hardware (e.g. a drone) that is Matrix enabled.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
...
<div className="question">
<h4 id="can-i-use-matrix-without-installing-a-matrix-client%3F"><a className="permalink" href="#can-i-use-matrix-without-installing-a-matrix-client%3F" aria-hidden="true">&#128279;</a> Can I use Matrix without installing a Matrix client?</h4>
<p>Yes! An ever increasing number of protocols are being <a href="#definitions">bridged</a> into Matrix, so if you use something like IRC on Freenode you may well be indirectly benefiting from Matrix, as others may be connected into the IRC channel via Matrix.</p>
<div className="definition-list">
<div className="definition-item definition-bridging">
<p><strong>bridging</strong></p>
<p>Bridging to Matrix means that it's possible to read and write to channels hosted outside matrix. For example, it's possible to speak in IRC and slack rooms.</p>
...
<div className="question">
<h4 id="what-is-a-homeserver%3F"><a className="permalink" href="#what-is-a-homeserver%3F" aria-hidden="true">&#128279;</a> What is a homeserver?</h4>
<p>A user's <a href="#definitions">client</a> connects to a single homeserver, which stores the communication history and account information for that user, and shares data with the wider Matrix ecosystem by synchronising communication history with other homeservers.</p>
<div className="definition-list">
<div className="definition-item definition-client">
<p><strong>Client</strong></p>
<p>Users in Matrix use one or more clients to communicate. This could be any combination of a web client, a command line client, a mobile client - or embedded clients built into existing apps. It could even be a piece of hardware (e.g. a drone) that is Matrix enabled.</p>
...
<div className="question">
<h4 id="what-is-a-mxid%3F"><a className="permalink" href="#what-is-a-mxid%3F" aria-hidden="true">&#128279;</a> What is a MXID?</h4>
<p>Matrix user IDs (MXID) are unique user IDs. They are in the format <code>@username:homeserver.tld</code> (this format is used to avoid confusing them with email addresses.) They are intended to be fairly hidden (although right now they are not) - instead you will find and identify other users via <a href="#definitions">3PID</a>s.</p>
<div className="definition-list">
...
<div className="question">
<h4 id="what-is-a-3pid%3F"><a className="permalink" href="#what-is-a-3pid%3F" aria-hidden="true">&#128279;</a> What is a 3PID?</h4>
<p>Third-party IDs (3PIDs) are IDs from other systems or contexts, such as email addresses, social network accounts and phone numbers.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
...
<div className="question">
<h4 id="what-is-an-identity-server%3F"><a className="permalink" href="#what-is-an-identity-server%3F" aria-hidden="true">&#128279;</a> What is an identity server?</h4>
...
<div className="question">
<h4 id="where-do-my-conversations-get-stored%3F"><a className="permalink" href="#where-do-my-conversations-get-stored%3F" aria-hidden="true">&#128279;</a> Where do my conversations get stored?</h4>
<p>Each <a href="#definitions">replicated</a> across all of the homeservers <em>whose users are participating in a given room</em>.</p>
<div className="definition-list">
<div className="definition-item definition-homeserver">
<p><strong>homeserver</strong></p>
<p>Each account in the Matrix federation is associated with a single homeserver. The software running at this server stores the history and account information for that user. Homeservers synchronise message history with other homeservers.</p>
...
<div className="question">
<h4 id="what-are-redactions%3F"><a className="permalink" href="#what-are-redactions%3F" aria-hidden="true">&#128279;</a> What are redactions?</h4>
...
<div className="question">
<h4 id="can-i-log-into-other-homeservers-with-my-username-and-password%3F"><a className="permalink" href="#can-i-log-into-other-homeservers-with-my-username-and-password%3F" aria-hidden="true">&#128279;</a> Can I log into other homeservers with my username and password?</h4>
...
<div className="question">
<h4 id="what-are-communities%3F"><a className="permalink" href="#what-are-communities%3F" aria-hidden="true">&#128279;</a> What are communities?</h4>
...
<h3 id="architecture"><a className="permalink" href="#architecture" aria-hidden="true">&#128279;</a> Architecture</h3>
<div className="question">
<h4 id="how-does-matrix-actually-work-architecturally%3F"><a className="permalink" href="#how-does-matrix-actually-work-architecturally%3F" aria-hidden="true">&#128279;</a> How does Matrix actually work architecturally?</h4>
<p>For an introduction to the Matrix architecture, see <a href="/docs/spec#architecture">https://matrix.org/docs/spec#architecture</a>.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
</div>
<div className="question">
<h4 id="what-is-a-room%3F"><a className="permalink" href="#what-is-a-room%3F" aria-hidden="true">&#128279;</a> What is a room?</h4>
<p>For a more thorough introduction see: <a href="/docs/spec#room-structure">https://matrix.org/docs/spec#room-structure</a>.</p>
...
<p>The Matrix Specification describes and prescribes the interaction between <a href="#definitions">Application Services</a> and more.</p>
<p>The spec is <a href="/docs/spec/">available to read on matrix.org</a>.</p>
<p>To contribute to the development of the Matrix Specification, see <a href="/docs/spec/proposals">https://matrix.org/docs/spec/proposals</a>.</p>
<div className="definition-list">
<div className="definition-item definition-client">
<p><strong>Client</strong></p>
<p>Users in Matrix use one or more clients to communicate. This could be any combination of a web client, a command line client, a mobile client - or embedded clients built into existing apps. It could even be a piece of hardware (e.g. a drone) that is Matrix enabled.</p>
...
<div className="question">
<h4 id="where-is-the-spec%3F"><a className="permalink" href="#where-is-the-spec%3F" aria-hidden="true">&#128279;</a> Where is The Spec?</h4>
<p>You can view the spec at <a href="/docs/spec/.">https://matrix.org/docs/spec/.</a></p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
</div>
<div className="question">
<h4 id="how-can-i-contribute-to-the-spec%3F"><a className="permalink" href="#how-can-i-contribute-to-the-spec%3F" aria-hidden="true">&#128279;</a> How can I contribute to The Spec?</h4>
<p>To contribute to the Matrix Specification, first take a look at the <a href="/docs/spec">documentation as it is currently written</a>, then review the <a href="/docs/spec/proposals">process for new proposals</a>. You should start by writing a publicly-accessible proposal describing your change.</p>
...
<div className="question">
<h4 id="what-is-the-process-for-adding-spec-proposals%3F"><a className="permalink" href="#what-is-the-process-for-adding-spec-proposals%3F" aria-hidden="true">&#128279;</a> What is the process for adding Spec proposals?</h4>
<p>See the documentation at <a href="/docs/spec/proposals">https://matrix.org/docs/spec/proposals</a>. In summary:</p>
<ul>
...
<div className="question">
<h4 id="what's-an-msc%3F"><a className="permalink" href="#what's-an-msc%3F" aria-hidden="true">&#128279;</a> What's an MSC?</h4>
...
<p>MSC numbers are taken from GitHub issues on the <a href="https://github.com/matrix-org/matrix-doc/issues">matrix-doc repo</a>. To see a list of all active MSCs, and to understand how to contribute your own, see <a href="/docs/spec/proposals">https://matrix.org/docs/spec/proposals</a>.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
</div>
<h3 id="voip"><a className="permalink" href="#voip" aria-hidden="true">&#128279;</a> Voip</h3>
<div className="question">
<h4 id="how-do-you-do-voip-calls-on-matrix%3F"><a className="permalink" href="#how-do-you-do-voip-calls-on-matrix%3F" aria-hidden="true">&#128279;</a> How do you do VoIP calls on Matrix?</h4>
...
<div className="question">
<h4 id="are-voip-calls-encrypted%3F"><a className="permalink" href="#are-voip-calls-encrypted%3F" aria-hidden="true">&#128279;</a> Are VoIP calls encrypted?</h4>
...
<h3 id="synapse"><a className="permalink" href="#synapse" aria-hidden="true">&#128279;</a> Synapse</h3>
<div className="question">
<h4 id="what-is-synapse%3F"><a className="permalink" href="#what-is-synapse%3F" aria-hidden="true">&#128279;</a> What is Synapse?</h4>
<p>Synapse is a reference &quot;<a href="#definitions">homeserver</a>&quot; implementation of Matrix from the core development team at matrix.org, written in Python 2/Twisted.  It is intended to showcase the concept of Matrix and let folks see the spec in the context of a codebase and let you run your own homeserver and generally help bootstrap the ecosystem.</p>
<div className="definition-list">
<div className="definition-item definition-homeserver">
<p><strong>homeserver</strong></p>
<p>Each account in the Matrix federation is associated with a single homeserver. The software running at this server stores the history and account information for that user. Homeservers synchronise message history with other homeservers.</p>
...
<div className="question">
<h4 id="how-do-i-install-synapse%3F"><a className="permalink" href="#how-do-i-install-synapse%3F" aria-hidden="true">&#128279;</a> How do I install Synapse?</h4>
...
<div className="question">
<h4 id="why-is-synapse-in-python%2Ftwisted%3F"><a className="permalink" href="#why-is-synapse-in-python%2Ftwisted%3F" aria-hidden="true">&#128279;</a> Why is Synapse in Python/Twisted?</h4>
<p>This is because both provide a mature and well known event-driven async IO framework for writing serverside code.  Whilst this has been okay for our initial experimentation and proof of concept, it's future <a href="#definitions">homeserver</a> work will be written in a more strongly typed language (e.g. Go).</p>
...
<div className="question">
<h4 id="why-aren't-you-using-an-orm-layer-like-sqlalchemy-in-synapse%3F"><a className="permalink" href="#why-aren't-you-using-an-orm-layer-like-sqlalchemy-in-synapse%3F" aria-hidden="true">&#128279;</a> Why aren't you using an ORM layer like SqlAlchemy in Synapse?</h4>
<p>Synapse is <em>very</em> database dependent (as of Oct 2015; this is improving in the near future however), and we like having the flexibility to sculpt our own queries.</p>
<div className="definition-list">
<div className="definition-close">close</div>
</div>
</div>
<div className="question">
<h4 id="will-synapse-share-my-chat-data-with-other-servers-in-the-federation%3F"><a className="permalink" href="#will-synapse-share-my-chat-data-with-other-servers-in-the-federation%3F" aria-hidden="true">&#128279;</a> Will Synapse share my chat data with other servers in the federation?</h4>
<p><a href="#definitions">Federation</a> in Matrix means that data is only shared between servers of participating users of a room. If all users in a room are on your server, no data is shared with other servers.</p>
<div className="definition-list">
<div className="definition-item definition-federation">
<p><strong>federation</strong></p>
<p>Federation means that separate instances of a service communicate - the best example of this is email servers, in which it's possible to send mail between difference service providers. For Matrix, this means that data about rooms and message history is shared between servers of participating users.</p>
...
<div className="question">
<h4 id="why-is-the-state_groups_state-table-so-large%3F-what-is-it-storing%3F"><a className="permalink" href="#why-is-the-state_groups_state-table-so-large%3F-what-is-it-storing%3F" aria-hidden="true">&#128279;</a> Why is the state_groups_state table so large? What is it storing?</h4>
...
<h2 id="definitions"><a className="permalink" href="#definitions" aria-hidden="true">&#128279;</a> Definitions</h2>
<table>
<thead>
<tr>
<th>Term</th>
...
<tr>
<td>Riot</td>
<td>Riot is a popular matrix client developed by the core matrix.org team. <a href="/docs/projects/try-matrix-now.html">It's available as a web app, on Android and on iOS</a>.</td>
</tr>
<tr>
<td>client SDK</td>
...
<tr>
<td>the spec</td>
<td>The Matrix Specification describes the interactions between actors in the Matrix ecosystem, including Server-Server and Client-Server. <a href="/docs/spec/">You can see the spec here.</a></td>
</tr>
<tr>
<td>sigil</td>
...
<tr>
<td>room</td>
<td>A room is a fundamental building bock of the matrix architecture: events are typically sent in the context of a room. A room is a conceptual place where users can send and receive events. Events are sent to a room, and all participants in that room with sufficient access will receive the event. <a href="/docs/spec#room-structure">See more detail.</a></td>
</tr>
<tr>
<td>bot</td>
...
<td>While Synapse can be installed using, Sqlite Postgres is preferred for any significant use.</td>
    ...
    <div className="mxcontent__nav mxcontent__nav--left">
        <div className="mxcontent__nav__section">
            <div className="mxcontent__nav__link title"><a href="#intro">Intro</a></div>
            <div className="mxcontent__nav__link"><a href="#basics">Basics</a></div>
            <div className="mxcontent__nav__link"><a href="#who-and-how">Who and How</a></div>
            <div className="mxcontent__nav__link"><a href="#concept">Concept</a></div>
            <div className="mxcontent__nav__link"><a href="#practical">Practical</a></div>
        </div>
        <div className="mxcontent__nav__section">
            <div className="mxcontent__nav__link title"><a href="#usage">Usage</a></div>
        ...
        <div className="mxcontent__nav__section">
            ...
            <div className="mxcontent__nav__link"><a href="#position-in-the-world">Position in the World</a></div>
            ...
            <div className="mxcontent__nav__link"><a href="#synapse">Synapse</a></div>
        </div>
        <div className="mxcontent__nav__section">
            <div className="mxcontent__nav__link title"><a href="#definitions">Definitions</a></div>
        </div>
