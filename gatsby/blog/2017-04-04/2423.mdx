...
TL;DR: <a href="https://matrix.org/vrdemo">here's the demo</a>!
...
In fact, the best way is to test it live: we've put together a quick demo at <a href="https://matrix.org/vrdemo">https://matrix.org/vrdemo</a> to show it off, so please <a href="https://matrix.org/vrdemo">give it a go!</a>
...
<a href="https://matrix.org/vrdemo">In the demo</a> you get:
<ol>
