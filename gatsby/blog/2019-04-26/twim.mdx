 ...
 * François and Benoit was at AndroidMakers Paris on Tuesday and Wednesday. We’ve seen plenty of interesting conferences and come back with many idea to improve Riot UX/UI/Implementation/testing/etc.
...
miniVector 0.8.29 is available on Goldy and Froid, and they are both "safe" -- TrustMe®... no, seriously now, the binaries were compiled seperately and are not suffering from the RA-problem afaik...
