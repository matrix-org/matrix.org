...
<ul>
 	<li style="font-weight: 400;">Our long-awaited new <a href="https://matrix.org/docs/guides/privacy_notice.html">privacy policy</a> &amp; <a href="https://matrix.org/docs/guides/terms_and_conditions.html">term &amp; conditions</a> for the matrix.org server are here - Phase 1 is complete!
</li>
