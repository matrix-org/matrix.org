...
Thus, we strongly urge you to have a look at the <a title="AS API" href="http://matrix.org/docs/spec/#application-service-api">AS API</a> - and as always we are happy to answer any questions at <a title="#matrix:matrix.org" href="https://matrix.org/beta/#/room/#matrix:matrix.org">#matrix:matrix.org</a>!