...
This week I chatted to Rick about the release of <a href="https://www.modular.im/">Modular</a>, Hosted Homeservers and more. We're pleased to be able to announce the availablity of a <a href="https://www.modular.im/hipchat">HipChat migration tool</a> to get people into Matrix.
...
<h2 id="matrixjsbotsdk">matrix-js-bot-sdk</h2>
<a href="https://github.com/turt2live">TravisR</a> reports that:
<blockquote>the <a href="https://github.com/turt2live/matrix-js-bot-sdk">matrix-js-bot-sdk</a> has received a bunch of updates currently residing on the develop branch. Changes include unit tests covering most of the library, appservice support improvements, handling of room version upgrades, and a bunch of bug fixes.</blockquote>
<a href="https://github.com/turt2live/matrix-js-bot-sdk">matrix-js-bot-sdk</a> was recently updated to have support for Application Services, and is a lighter alternative to the <a href="https://github.com/matrix-org/matrix-js-sdk">matrix-js-sdk</a>.
