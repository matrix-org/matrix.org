...
There is an explanation of the endpoints required for this <a href="https://matrix.org/docs/spec/client_server/r0.3.0.html#end-to-end-encryption">in the CS API docs</a>.
