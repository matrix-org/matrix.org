...
![Edits and reactions in RiotX](/blog/img/edits.jpg)

...and here’s a screenshot of the final test jig for cross-signing devices in end-to-end encryption, so you will never have to manually verify new devices for a trusted user ever again!  We demoed a *very* early version of this at FOSDEM, but this here is the real deal, after several iterations of the spec and implementation to nail down the model:

![Cross-signing test jig](/blog/img/cross-signing.png)

So, there you have it - welcome to Matrix 1.0, and we look forward to our backlog of feature work now landing!

Massive massive thanks to everyone who has stuck with the project over the years and helped support and grow Matrrix - little did we think back in May 2014 that it’d take us this long to exit beta, but hopefully you’ll agree that it’s been worth it :)
...
...and that nowadays we actually know how power level work, in excruciating and (hopefully) well-specified manner :)
...
Finally, huge thanks to everyone who has continued to support us through thick and thin on [Patreon](https://patreon.com/matrixdotorg), [Liberapay](https://liberapay.com/matrixdotorg) or other platforms.  Every little counts here, both in terms of practically keeping the lights on, and also inspiring larger donations & financial support.
