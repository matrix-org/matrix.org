...
It is also worth noting that Synapse 1.0.0 is the last release that will support Python 2.x and Postgres 9.4. You can read more about it [here]([https://matrix.org/blog/2019/04/08/synapse-deprecating-postgres-9-4-and-python-2-x](https://matrix.org/blog/2019/04/08/synapse-deprecating-postgres-9-4-and-python-2-x)) but the TL;DR is that you should upgrade asap.
...
Synapse 1.0 is just one component of a larger Matrix 1.0 release, you can read all about Matrix 1.0 LINK here.
