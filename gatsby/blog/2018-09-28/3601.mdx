...
<a href="http://matrix.to/#/@bhat:encom.eu.org">Black Hat</a> has been working on the client formerly-known-as-Matrique: <a href="https://gitlab.com/b0/spectral">Spectral</a>:
<blockquote>I added elevation shadows for some components, such as message bubble, panels, etc.</blockquote>
<a href="https://matrix.org/blog/wp-content/uploads/2018/09/spectral-raised.png"><img class="alignnone size-full wp-image-3603" src="https://matrix.org/blog/wp-content/uploads/2018/09/spectral-raised.png" alt="" width="960" height="674" /></a>
