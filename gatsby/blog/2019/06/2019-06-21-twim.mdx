...
> Furthermore mx-puppet-bridge is written in typescript and based on travis' [matrix-bot-sdk](https://github.com/turt2live/matrix-js-bot-sdk).  
...
> One-time keys uploading part is implementing currently. Draft device keys uploading is also here. The implementaion follows E2EE guide: <https://matrix.org/docs/guides/end-to-end-encryption-implementation-guide>  
> My contribution and reports are currently here: <https://github.com/a-andreyev/libQuotient/wiki/GSoC-2019-reports>. Also feel free to rearch me via Quotient group <https://matrix.to/#/#quotient:matrix.org>.  
