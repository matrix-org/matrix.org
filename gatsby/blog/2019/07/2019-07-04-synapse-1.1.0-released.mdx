...
should expect lots of associated performance wins over the coming months. See the [upgrade notes](https://github.com/matrix-org/synapse/blob/master/UPGRADE.rst) for more.
