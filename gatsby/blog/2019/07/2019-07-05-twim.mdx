...
>
> If you have any questions for any of these, please join our channel > [#mx-puppet-bridge:sorunome.de](https://matrix.to/#/) #mx-puppet-bridge:sorunome.de). Software doesn't write itself, please consider > [donating on liberapay](https://liberapay.com/Sorunome/donate)!
...
### Quaternion now with Matrix URI suppport
...
> with the release of synapse 1.1.0 the [avhost/docker-matrix image][avhost-docker-matrix] switched to running synapse with jemalloc by default, but since that was basically announced last week (there was a specific jemalloc image)
