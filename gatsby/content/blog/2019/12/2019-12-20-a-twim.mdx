...
Very thorough article on accessibility in Riot/Matrix, written partly in light of the Mozilla announcement. [https://marcozehe.de/2019/12/20/how-to-get-around-matrix-and-riot-with-a-screen-reader/](https://marcozehe.de/2019/12/20/how-to-get-around-matrix-and-riot-with-a-screen-reader/)
...
> another blog post has appeared on the ruma website: [https://www.ruma.io/news/these-weeks-in-ruma-2019-12-14/](https://www.ruma.io/news/these-weeks-in-ruma-2019-12-14/)
...
> I've started another bot project: [https://github.com/half-shot/matrix-zammad](https://github.com/half-shot/matrix-zammad). This currently splurts zammad tickets into Matrix rooms, and will eventually do a lot more.
