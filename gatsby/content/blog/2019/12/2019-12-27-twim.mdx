...
> The German Army is considering using Matrix as "secure WhatsApp" for solders.
> (In German)
...
### kapsi.fi has set up a Martrix homeserver

[Cos](https://matrix.to/#/@cos:hacklab.fi) reported:

> Finnish non-profit hosting service kapsi.fi has set up a Martrix homeserver for their members. Kapsi has around 5000 members and 20 volunteer administrators. Instructions for use (in FInnish) at <https://www.kapsi.fi/palvelut/matrix.html>
...
> Matrix bot for convert youtube video to voice.
>
