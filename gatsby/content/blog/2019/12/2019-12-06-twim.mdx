...
>
> This week, the Spec Core Team are once again focusing on [MSC2370](https://github.com/matrix-org/matrix-doc/pull/1270) (URL resolver in media), [MSC2366](https://github.com/matrix-org/matrix-doc/pull/2366) (accept in verification), and [MSC1849](https://github.com/matrix-org/matrix-doc/pull/1849) (aggregations/edits).
...
> RiotX: Release 0.9.1 including new login flow and account creation has been done on Thursday. Read marker has been reworked, to simplify user experience on mobile. Also you can type and send user pills.
>
