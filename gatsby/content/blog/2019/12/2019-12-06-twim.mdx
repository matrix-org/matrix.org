...
>
> Get the release notes here: [https://github.com/matrix-org/matrix-synapse-ldap3/releases/tag/v0.1.4](https://github.com/matrix-org/matrix-synapse-ldap3/releases/tag/v0.1.4)
...
> let me share Messagerie: [https://github.com/manuroe/messagerie](https://github.com/manuroe/messagerie), an iOS app and, maybe, in the future, a MacOS app.
>
...
>
> rejoice! Code is [https://github.com/anoadragon453/msc-chatbot](https://github.com/anoadragon453/msc-chatbot)

### malobot - send or receive location messages

[Cos](https://matrix.to/#/@cos:hacklab.fi) said:

> It would be cool to be able to share location in Matrix rooms. This bot by cos solves the egg part in chicken and egg problem of having no clients able to send or receive location messages. Next we need a mobile client that can send location updates. Which one will be the first? [https://github.com/vranki/malobot/](https://github.com/vranki/malobot/)
