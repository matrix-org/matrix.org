...
![continuum](/blog/img/2019-0-13-continuum.png)
...
> * Two minor releases has been done (0.9.5 and 0.9.6), to allow auto configuration of the homeserver in the login screen with a configuration link, and to fix an issue with SSO using Google account.
...
[@matthew:matrix.org](https://matrix.to/#/@matthew:matrix.org) reported:
