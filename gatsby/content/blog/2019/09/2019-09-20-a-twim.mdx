...
> There was an issue with buildkite which in the end let to the situation the the built apk had a lower versionCode as the apps already in the repo. The repo was then "intelligent enough" to no offer it as update.
