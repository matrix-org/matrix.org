...
Construct is written for maximum performance in C++, and is developing rapidly - join [#construct:zemos.net] for more info.
...
About a month ago we started selling merch at [shop.matrix.org], and WOWEE ZOMG we sold a lot of stuff! If you are happy with your purchase I'd love to here from you - share photos of where you put the stickers or you happily wearing the t-shirt in [#twim:matrix.org] and I'll make a little collage.
