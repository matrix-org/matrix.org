...
>
> You can find more details about the project and this release at [https://brendan.abolivier.bzh/install-party-1.0/](https://brendan.abolivier.bzh/install-party-1.0/), and in [#install-party:abolivier.bzh](https://matrix.to/#/#install-party:abolivier.bzh) 🙂
...
> Also, [https://github.com/matrix-org/matrix-appservice-bridge/releases/tag/1.11.1](https://github.com/matrix-org/matrix-appservice-bridge/releases/tag/1.11.1)
...
>
> More photos: [http://dittochat.org](http://dittochat.org)
...
> Donate: [https://liberapay.com/Sorunome](https://liberapay.com/Sorunome)
...
>
> [https://matrix.org/_matrix/media/r0/download/matrix.org/ziPiTnybBwEEcSMPZRjhNlsV](https://matrix.org/_matrix/media/r0/download/matrix.org/ziPiTnybBwEEcSMPZRjhNlsV)
...
Riot v1.5.1-rc.1 is up on [https://riot.im/staging](https://riot.im/staging) with a collection of bugfixes, some further a11y fixes and... a new reaction picker from tulir!
...
> I made a bot that can give you links to TV show episodes that get mentioned in rooms: [https://github.com/anoadragon453/matrix-episode-bot](https://github.com/anoadragon453/matrix-episode-bot)
>
