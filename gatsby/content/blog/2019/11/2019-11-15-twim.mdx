...
Testflight: [https://testflight.apple.com/join/9M0ERlKd](https://testflight.apple.com/join/9M0ERlKd)  
Feedback: [https://ditto.upvoty.com](https://ditto.upvoty.com)
...
[https://www.ruma.io/news/new-releases-2019-11-05/](https://www.ruma.io/news/new-releases-2019-11-05/)
...
>
> [https://matrix.org/_matrix/media/r0/download/matrix.org/GMyoaOATXbdcgKnGXCgpDnEA](https://matrix.org/_matrix/media/r0/download/matrix.org/GMyoaOATXbdcgKnGXCgpDnEA)
...
>
> There are some screenshots on the PR: [https://github.com/matrix-org/matrix-react-sdk/pull/3620](https://github.com/matrix-org/matrix-react-sdk/pull/3620)
...
> I (and hopefully others) feel that matrix needs more home servers. That's why I wrote a guide for setting one up using free resources and @benpa was kind enough to include it on matrix.org: [https://matrix.org/docs/guides/free-small-matrix-server/](https://matrix.org/docs/guides/free-small-matrix-server/)
...
> Matrix-Alertmanager, a bot that relays Prometheus Alertmanager alerts to Matrix rooms, gets a new release v0.1.0. Thanks to "daniego" the messages are now HTML formatted. Also dependencies have been bumped, Matrix JS SDK by "Lyr" and all the other deps by me. For more info: [https://git.feneas.org/jaywink/matrix-alertmanager](https://git.feneas.org/jaywink/matrix-alertmanager)
...
> [https://aa13q.ru/#!posts/2019-11-01-matrix-2600/meta.md](https://aa13q.ru/#!posts/2019-11-01-matrix-2600/meta.md)
