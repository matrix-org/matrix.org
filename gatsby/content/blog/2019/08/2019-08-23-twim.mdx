...
It's [CCCamp 2019](https://events.ccc.de/camp/2019/wiki/Main_Page) this weekend. Tonight, [anoa](https://matrix.to/#/@andrewm:amorgan.xyz) will be leading a "Install Synapse" workshop - keep decentralisation growing!
...
> The matrix-appservice-bridge library also saw it's 1.10.0 release this week, which has *experimental* support for bridge errors and also has a bugfix related to room upgrades.
...
> there is now a room specifically for the LaTeX fork hosted on www.pigeon.digital where you can leave any feeback, report any bugs, or ask for any help: [#pigeon.digital:matrix.org](https://matrix.to/#/#pigeon.digital:matrix.org)
...
Fractal, GNOME client, continues to progress:
