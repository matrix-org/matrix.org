...
> [https://github.com/matrix-org/matrix-react-sdk/pull/3251](https://github.com/matrix-org/matrix-react-sdk/pull/3251)
...
You can try the compact mode at [https://neo.pixie.town/app/?compactMode=true](https://neo.pixie.town/app/?compactMode=true).
...
Check it out at: [https://github.com/Half-Shot/matrix-github](https://github.com/Half-Shot/matrix-github)
...
> I finished version 1.5 of my small command line based federation tester. The bash script relies heavily on popular Unix tools like awk, curl, jq, sed and so on. Compared to [https://federationtester.matrix.org](https://federationtester.matrix.org), the outputs are a little more detailed and additional tests are performed, especially on the supported SSL protocols. Currently, it has only been tested under Linux.  
> The current version improves the handling of port in the .well-known and DNS SRV configuration.  
> You can download it from [#cli_federation-tester_de:matrix.chat-secure.de] or directly via [https://matrix.chat-secure.de/_matrix/media/r0/download/matrix.chat-secure.de/MDwYLdrxRdudmcgDzBEALCzN](https://matrix.chat-secure.de/_matrix/media/r0/download/matrix.chat-secure.de/MDwYLdrxRdudmcgDzBEALCzN)

## Dept of Bots 🤖

[jcgruenhage] has been working on a bot in relation to the startup he's working with:

> I made a bot for issuing Json Web Tokens to matrix users based on what homeserver they are on. It's implemented as a [maubot] plugin (best way to write bots right now) and licensed under the AGPLv3. You can find it over at [https://gitlab.com/famedly/bots/jwt](https://gitlab.com/famedly/bots/jwt), and talk about it in [#jwt-bot:famedly.de]  
...
red_sky: [Nheko] now has a weblate instance set-up for users to contribute translations: [https://weblate.nheko.im/engage/nheko/](https://weblate.nheko.im/engage/nheko/)
