...
> This Week in Ruma: [https://www.ruma.io/news/this-week-in-ruma-2019-08-11/](https://www.ruma.io/news/this-week-in-ruma-2019-08-11/)

He was also a guest of the [Rustacean Station](https://rustacean-station.org/) podcast this week:

> Ruma and the Matrix Communication Protocol: An Interview with Jimmy Cuadra (Rustacean Station podcast): [https://rustacean-station.org/episode/001-ruma/](https://rustacean-station.org/episode/001-ruma/)
...
> [https://matrix.org/_matrix/media/r0/download/matrix.org/kVfBsoAsguMmESNThxnUmaTM](https://matrix.org/_matrix/media/r0/download/matrix.org/kVfBsoAsguMmESNThxnUmaTM)
...
> This week I made a Notification/Remind-Me-Bot using Travis's bot sdk, it took me 1 and half days, and is able to - set reminder, check reminder, cancel reminder, set interval reminder, cancel interval reminder. It is also able to store multiple reminders and cancel them using the numbers 1 - ∞ . Here is a link to my Github repo - [https://github.com/joakimvonanka/Matrix-Remind-me-bot](https://github.com/joakimvonanka/Matrix-Remind-me-bot)
...
>
> * Video: [https://media.ccc.de/v/froscon2019-2330-matrix](https://media.ccc.de/v/froscon2019-2330-matrix)
> * Slides: [https://programm.froscon.de/2019/system/event_attachments/attachments/000/000/579/original/presentation.pdf](https://programm.froscon.de/2019/system/event_attachments/attachments/000/000/579/original/presentation.pdf)
