...
> But my programming progress on `master` looks a bit silent because I swap to [https://github.com/poljar/matrix-nio](vector://vector/webapp/matrix-nio).
...
Anton ([@antonivan:matrix.org](https://matrix.to/#/@antonivan:matrix.org)) is working at Matrix Towers this summer for work experience. He's been learning about Matrix and [matrix-js-bot-sdk]:
