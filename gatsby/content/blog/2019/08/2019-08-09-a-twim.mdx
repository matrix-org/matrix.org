...
[ChronosX88](https://matrix.to/#/@chronosx88:netwhood.online) announced that he is "developing a lightweight Matrix server" - check on their progress at <https://github.com/signaller-matrix/signaller>, also join [#signaller_dev_en:netwhood.online](https://matrix.to/#/#signaller_dev_en:netwhood.online).
...
Seeing this, I wondered, "y tho?", luckily progserega was able to explain with a graphic! They say a picture paints a thousand words, and it's clear from the conversation below why he'd want to have text-to-speech capabilities.

![Text to Speech](/blog/img/2019-08-09-audiototext.png)
