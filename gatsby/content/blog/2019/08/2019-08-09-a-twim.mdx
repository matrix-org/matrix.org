...
Interesting reading: [https://github.com/matrix-org/synapse/blob/master/docs/metrics-howto.rst](https://github.com/matrix-org/synapse/blob/master/docs/metrics-howto.rst)
...
Yes, it's true: Official Matrix Merch is available now. There are stickers, t-shirts and hoodies all available now, go and claim yours from [https://shop.matrix.org](https://shop.matrix.org).
...
[https://programm.froscon.de/2019/events/2330.html](https://programm.froscon.de/2019/events/2330.html)
...
This Week in Ruma: [https://www.ruma.io/news/this-week-in-ruma-2019-08-04/](https://www.ruma.io/news/this-week-in-ruma-2019-08-04/)

Also, get live-streamed Ruma development: [https://www.jimmycuadra.com/posts/twitch-live-streams-of-ruma-development/](https://www.jimmycuadra.com/posts/twitch-live-streams-of-ruma-development/)

Does the video include time spent waiting for `async` to land in Rust?

### signaller - new "lightweight server"

[ChronosX88](https://matrix.to/#/@chronosx88:netwhood.online) announced that he is "developing a lightweight Matrix server" - check on their progress at [https://github.com/signaller-matrix/signaller](https://github.com/signaller-matrix/signaller), also join [#signaller_dev:netwhood.online](https://matrix.to/#/#signaller_dev:netwhood.online).
...
>
> 1. [matrix-key-server](https://github.com/t2bot/matrix-key-server) ( #matrix-key-server:t2bot.io ) is an implementation of a Matrix key server with notary support. Although it follows the specification, it has not been tested against Synapse. It is however fully featured: check it out on the federation tester ([https://federationtester.matrix.org/#keys.t2host.io](https://federationtester.matrix.org/#keys.t2host.io)) or by querying it yourself ([https://keys.t2host.io/_matrix/key/v2/query/matrix.org](https://keys.t2host.io/_matrix/key/v2/query/matrix.org)).
>
...
> * Release of v0.3.0 on Friday: full changelog can be found here: [https://github.com/vector-im/riotX-android/releases/tag/v0.3.0](https://github.com/vector-im/riotX-android/releases/tag/v0.3.0)
...
> Download links: [https://github.com/ma1uta/ma1sd/releases/tag/2.1.1](https://github.com/ma1uta/ma1sd/releases/tag/2.1.1) (archives and the deb package) and [https://hub.docker.com/r/ma1uta/ma1sd](https://hub.docker.com/r/ma1uta/ma1sd) for docker image.
...
> Hi folks, we've released a RC of the next irc bridge version. Check it out at [https://github.com/matrix-org/matrix-appservice-irc/releases/tag/0.13.0-rc1](https://github.com/matrix-org/matrix-appservice-irc/releases/tag/0.13.0-rc1)
...
> I started a "matrix-xmpp-filter" project. It's like matrix-ircd, but with xmpp instead of irc. It can also filter messages by weekday, time and regular expressions. Target audience is Sailfish phone users, but it could be used with other xmpp clients too (no xmpp MUC support required). [https://k2c42.dy.fi/matrix-xmpp-filter.git/](https://k2c42.dy.fi/matrix-xmpp-filter.git/) [#matrix-xmpp-filter:ellipsis.fi](https://matrix.to/#/#matrix-xmpp-filter:ellipsis.fi).

### matrix-github (GH issues bridge)

[Half-Shot]:

> [https://github.com/Half-Shot/matrix-github](https://github.com/Half-Shot/matrix-github) has had quite a few updates. Notably:
>
...
> I develop matrix Bot, which converting voice messages to text. It use Yandex Speech API and Yandex API cloud (some as aws) for temporary store voice-data before converting. [https://github.com/progserega/voice2textMatrix](https://github.com/progserega/voice2textMatrix)
> Bot have such logic:
>
