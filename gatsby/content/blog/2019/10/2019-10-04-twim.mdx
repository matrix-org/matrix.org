...
* Ubucon [https://sintra2019.ubucon.org/](https://sintra2019.ubucon.org/)
* PyCon Ireland [https://python.ie/pycon-2019/](https://python.ie/pycon-2019/)
* OggCamp [https://oggcamp.org/](https://oggcamp.org/)
* MozFest [https://www.mozillafestival.org/en/](https://www.mozillafestival.org/en/)
...
> Aaaaaaaaaaand shipped 🥳 [https://github.com/matrix-org/matrix-appservice-slack](https://github.com/matrix-org/matrix-appservice-slack) (1.0 is out!)
...
Big release for riot-web, check out their release: [https://medium.com/@RiotChat/new-privacy-controls-for-riot-dc3661888563](https://medium.com/@RiotChat/new-privacy-controls-for-riot-dc3661888563)
...
> As a proof of concept, I have created a little Matrix client with Flutter for Web, named FluffyWeb. This client has only basic features but it shows the possibilities of Flutter for Web and it seems to work fine so far. The client has a responsive design and should work on mobile fine too. Check it out at: [https://christianpauly.gitlab.io/fluffyweb/](https://christianpauly.gitlab.io/fluffyweb/)
...
> I made a bot that gives the link for msc names. Code is here: [https://github.com/anoadragon453/msc-chatbot](https://github.com/anoadragon453/msc-chatbot)
