...
seamlessly. And for those wondering, yes it works with Mattermost too (since their API is comapatible with Slack)!
...
as a tool to mangement large scale Slack bridge deployments. This tool is provided by [Cadair](https://matrix.to/#/@Cadair:matrix.org) and [SolarDrew](https://matrix.to/#/@SolarDrew:matrix.org)
