...
> I updated the mvgorcum/docker-matrix:v1.4.1 tag in about half an hour after the release
...
>
> (As a side note, the reason for the Server-Sent Events middleware project is just that I wanted to try writing some SSE client software, but as it so happens I didn't have any good servers to connect it to)
