...
> The project is called Install Party, and lives at [https://github.com/babolivier/install-party](https://github.com/babolivier/install-party), and if you want to chat about it I've just created [#install-party:abolivier.bzh](https://matrix.to/#/#install-party:abolivier.bzh) 😉
...
> Just FYI, the matrix slack bridge is now available via NixOS: [https://github.com/NixOS/nixpkgs/pull/70753](https://github.com/NixOS/nixpkgs/pull/70753)

## Dept of Clients 📱

### riots.im available via IPFS

Remember [https://riots.im](https://riots.im) from last week? Now available on IPFS!
