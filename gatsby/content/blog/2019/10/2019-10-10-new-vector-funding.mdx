...
Massive news for the Matrix ecosystem today: [New Vector ](vector.im)(the
...
professional UI/UX design to the team; supporting the huge amount of
...
You can read things from the NV angle over at https://blog.vector.im.  We hope
you’re as excited as we are to open a whole new chapter as Matrix picks up yet
more momentum :D
