...
> * We released [0.7.0](https://github.com/vector-im/riotX-android/releases/tag/v0.7.0) this week. You have now read markers and can share content to Riot. You should also find the app even more quicker.
