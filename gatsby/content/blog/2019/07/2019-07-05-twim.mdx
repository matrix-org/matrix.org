...
>
> The new release is having very final minute checks, and will be available at [https://github.com/matrix-org/matrix-appservice-slack/releases](https://github.com/matrix-org/matrix-appservice-slack/releases) shortly.
