...
>   * Full perimeter can be found here: [https://github.com/vector-im/riotX-android/milestone/6?closed=1](https://github.com/vector-im/riotX-android/milestone/6?closed=1)
>   * Known limitation: crash on device running Android KitKat (4.4). We are considering supporting only device running Android Lollipop (5.0) and up (see/approve/comment [https://github.com/vector-im/riotX-android/issues/405](https://github.com/vector-im/riotX-android/issues/405))
...
> I was told that people here might be interested: I just wrote a small bot that can reply with PNG renderings of maths ([https://github.com/thosgood/matrix-maths-bot](https://github.com/thosgood/matrix-maths-bot))

and then, [tulir] <del>blatantly ripped him off</del> was inspired to create a maubot providing the LaTeX to SVG rendering: [https://github.com/maubot/tex](https://github.com/maubot/tex)
