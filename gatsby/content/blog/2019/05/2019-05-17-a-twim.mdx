...
<br /><del>If</del> Since you've been chatting on Matrix this week, you'll have noticed some new features rolling out.
...
> did alot of changes on tangent to make it more stable and performant, only registration and guest login are left to do, git changed to [https://gitlab.com/sanlox/tangent](https://gitlab.com/sanlox/tangent)

Test the latest at: [https://sanlox.dev/tangent/](https://sanlox.dev/tangent/)
...
> Try Scylla here: [https://scylla.danilafe.com](https://scylla.danilafe.com)  
...
[Ananace] updated their k8s packaging for Synapse to 0.99.4: [https://github.com/ananace/matrix-synapse](https://github.com/ananace/matrix-synapse)
...
There are some important differences between this and [https://github.com/matrix-org/synapse/tree/master/contrib/docker](https://github.com/matrix-org/synapse/tree/master/contrib/docker):
