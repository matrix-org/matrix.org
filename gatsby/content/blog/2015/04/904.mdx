...
<dl>
  ...
  <dt>2: Enable synapse metrics:</dt>
  <dd>
  ...
  <dt>5: Add a prometheus target for synapse</dt>
  <dd>
  ...
  <dt>6: Start prometheus:</dt>
  <dd>
    <pre>./prometheus -config.file=prometheus.conf</pre>
  </dd>

  <dt>7: Wait a few seconds for it to start and perform the first scrape,</dt>
  <dd>
