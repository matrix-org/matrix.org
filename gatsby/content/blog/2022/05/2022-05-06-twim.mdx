...
<iframe width="560" height="315" src="https://www.youtube.com/embed/n78tHoCx1es" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> 
> This MSC has actually been potentially(?) superceded by [MSC3382](https://github.com/matrix-org/matrix-spec-proposals/pull/3382). In short, both look to provide a solution to the problem of attaching (multiple!) images to messages, such that clients can display an album of images in a single event in the timeline.
> 
...
> * New `hookshot_connection_event(_failed)` metrics for tracking succesful event handling.
