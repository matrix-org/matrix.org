...
Last year was the first time FOSDEM was hosted on Matrix, and it was generally a huge success - and sohe FOSDEM team trusted us again this year and we’re happy to say that it seems to have gone really well! This year’s FOSDEM was massive once again, featuring 654 speakers, 731 events, and 103 tracks.
...
<figure>
	<img src="/blog/img/2022-07-02-fosdem_attendees_heatmap.png" alt="FOSDEM attendees heatmap" />
	<figcaption>CPU usage and message send time heatmap on attendees.fosdem.org</figcaption>
</figure>
...
<figure>
	<img src="/blog/img/2022-07-02-fosdem_homescreen.png" alt="Homescreen of chat.fosdem.org" />
	<figcaption>Homescreen of chat.fosdem.org</figcaption>
</figure>

One of the great things is it doesn’t require heavy modifications to Element: anyone who installs their own instance of Element can use a simple html file to display relevant information to their audience.  In fact, the Element deployment on chat.fosdem.org was just normal mainline Element without any patches.
...
<figure>
	<img src="/blog/img/2022-07-02-fosdem_space.png" alt="FOSDEM Space listing all the FOSDEM rooms" />
	<figcaption>FOSDEM Space listing all the FOSDEM rooms</figcaption>
</figure>
...
<figure>
	<img src="/blog/img/2022-07-02-fosdem_stand.png" alt="FOSDEM stand with maximised widget view" />
	<figcaption>FOSDEM stand with maximised widget view</figcaption>
</figure>
...
<figure>
	<img src="/blog/img/2022-07-02-fosdem_backstage.png" alt="Backstage room where the speaker and host could talk and see the questions" />
	<figcaption>Backstage room where the speaker and host could talk and see the questions</figcaption>
</figure>
