...
also be unwelcomed indicator that a user is currently reading a certain room,
...
Synapse 1.65 implements the new experimental error codes documented by
...
This release of Synapse also stabilises the implementation of
...
possible to search specifically for public spaces.
