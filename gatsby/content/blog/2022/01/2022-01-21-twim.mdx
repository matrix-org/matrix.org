...
> I’ve created (bog post)[https://helderferreira.io/matrix-well-known-with-cloudflare/] explaining the way to host the static well-known files using cloudflare workers gaining speed and stability
