...
<iframe width="560" height="315" src="https://www.youtube.com/embed/T0bm6JWV1js" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Dept of we've been away for holidays

This week in Matrix should be called Three Weeks in Matrix, since there hasn't been TWIM updates during the holiday season. [Nico](https://matrix.to/#/@deepbluev7:neko.dev) has published a [communitwim](https://blog.neko.dev/posts/bootleg-twim.html) while I was away. All the news reports since the last official TWIM still made it to the post you're currently reading!
...
> ## The graph
> 
> I don't know why it came out yellow, but I blame WSL. Here's a stacked graph of MSC progress:
> 
> 
...
> 
> The client has been relicesed to LGPL. This means that you can now use Cactus Comments in non-GPL compatible projects.
