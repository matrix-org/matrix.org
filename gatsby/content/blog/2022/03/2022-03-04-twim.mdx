...
> 
> Our switch to [Poetry](https://python-poetry.org/) for dependency management has come a few steps closer, by removing [tox](https://tox.wiki) from our Continous Integration, and converting some of our ad-hoc scripts to proper Python [entry points](https://packaging.python.org/en/latest/specifications/entry-points/).
> 
