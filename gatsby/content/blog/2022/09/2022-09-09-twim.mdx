...
<iframe width="560" height="315" src="https://www.youtube.com/embed/wFSmDn-PlYg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> This week saw the merge of [PR/Issue #1000](https://github.com/matrix-org/matrix-rust-sdk/pull/1000), a milestone, that, though random, marks the continous progress and pace this project has taken up. 🥂 to the next 1000!
> 
