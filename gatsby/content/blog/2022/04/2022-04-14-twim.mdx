...
> * Allow priority ordering of connection command handling by setting a`priorty: number` key in the state event content. ([#293](https://github.com/matrix-org/matrix-hookshot/issues/293))
