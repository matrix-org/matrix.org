...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Uunj5mDtt1s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> ![](/blog/img/jPRBgbOcSrlduHmagBCjccxW.png)
...
> 
> It was designed to enable users on Windows to easily access things like custom powerlevel rooms and manual room upgrades that normally require using Linux to run bash scripts if one does not want to figure out how to make the web requests using their preferred method them selfs. 
> 
...
> 
> We can also report amazing news from the Async-UniFFI-front: we have the first async-uniffi-swift code runnin now. Exciting times!
> 
> 
...
> ```
> 
> The operator takes care of the deployment and lifecycle mangement of the Synapse instance. Similarly, the `Heisenbridge` and `MautrixSignal` resources can also be deployed alongside Synapse and are managed by the operator.
> 
