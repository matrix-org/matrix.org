...
[Improving `filter_events_for_client`](https://github.com/matrix-org/synapse/pull/14527) gave us a first nice bump as visible on this graph:
...
[aggregations](https://github.com/matrix-org/synapse/pull/14510) managed to got yet another nice improvement:

![](/blog/img/2022-12-07-bundled-aggregations-improvement.png)
