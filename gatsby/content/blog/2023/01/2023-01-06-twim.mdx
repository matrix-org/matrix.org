...
> * Bulma has been completely replaced by TailwindCSS, allowing greater flexability with styling. This involved a rewrite of the navbar, post, login, and other components of the UI.
