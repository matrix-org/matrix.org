...
[MSC3966](https://github.com/matrix-org/matrix-spec-proposals/pull/3966), and the removal of the spurious `dont_notify`
action from the defaults for the ``.m.rule.reaction` pushrule.
...
a fix for a bug introduced in Synapse 1.75 where the [portdb script](https://matrix-org.github.io/synapse/release-v1.78/postgres.html#porting-from-sqlite)
