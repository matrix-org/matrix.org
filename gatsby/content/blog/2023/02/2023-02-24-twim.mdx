...
> 
> This week's ~~random~~ chosen MSC is [MSC3575: Sliding Sync](https://github.com/matrix-org/matrix-spec-proposals/pull/3575)! It's one of the largest (or is the largest?) MSCs we've ever had, and dramatically changes how clients actually get updates from the server. It's worth the read if you're a client developer, and on a path to FCP - get your feedback in soon.
> 
> ## The Chart
> 
...
> [[https://github.com/alphapapa/ement.el][Ement.el]], a Matrix client for the venerable [[https://www.gnu.org/software/emacs/][GNU Emacs]] text editor and Lisp environment, has been released at v0.6.  Changes since the last release include:
> 
> *Additions*
