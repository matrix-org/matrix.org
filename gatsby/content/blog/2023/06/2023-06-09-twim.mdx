...
> 
> The technical team is chugging away implementing the screens for the upcoming Alpha of Acter3, like the new [navigation bar](https://github.com/acterglobal/a3/pull/609), [login flow](https://github.com/acterglobal/a3/pull/620) and its acommpanying pages. As it will be an alpha, an Element-App-insipired [labs settings system](https://github.com/acterglobal/a3/pull/618) has been implemented, too, allowing users to opt-in into still exprimental features while they are being developed.
> 
