...
> [https://github.com/alphapapa/ement.el](Ement.el), a Matrix client for the [https://www.gnu.org/software/emacs/](GNU Emacs) Lisp machine and text editor, was graciously feature by David Wilson in his weekly [https://www.youtube.com/watch?v=KCmlupc9z34](System Crafters stream).  He thoroughly demo'ed Ement's powerful, unique features, giving a great introduction to new users, and showing the power of Emacs in general.  Check it out!
