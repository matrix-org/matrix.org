...
I am hoping to have an actual release on crates.io by the end of the day. If you have any thoughts join #rumatui:matrix.org  or check it out on [github](https://github.com/DevinR528/RumaTui).
