...
Client-Server r0.6.1 contains a number of clarifications as well as SSO support for authorization, "soft logout" to avoid needlessly destroying e2e history, and new ways to publish aliases within rooms.
...
The full changelog for Client-Server r0.6.1 is:
...
The full changelog for Server-Server (Federation) r0.1.4 is:

## New Endpoints

  - Add new `POST /publicRooms` endpoint for filtering the room directory. ([\#2035](https://github.com/matrix-org/matrix-doc/issues/2035))
