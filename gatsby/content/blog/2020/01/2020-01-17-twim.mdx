...
> * Implement variables for name patterns
>
> As always, if you have any questions, please drop by [the support chat](https://matrix.to/#/[#mx-puppet-bridge:sorunome.de](https://matrix.to/#/#mx-puppet-bridge:sorunome.de)) and consider to [donate](https://liberapay.com/Sorunome/donate)! 🦊🦊🦊
