...
This is in response to a talk Moxie Marlinspike gave at 36c3. There is [another response here](https://blog.jabberhead.tk/2019/12/29/re-the-ecosystem-is-moving/).
...
> [matrix-media-repo](https://github.com/turt2live/matrix-media-repo) now has a v1.0.0-rc.2 to fix a small bug with exports in v1.0.0-rc.1
...
>
> If you like these projects, please check out the [support chat](https://matrix.to/#/[#mx-puppet-discord:sorunome.de](https://matrix.to/#/#mx-puppet-discord:sorunome.de)) and consider to [donate](https://liberapay.com/Sorunome)!
