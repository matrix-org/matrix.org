...
[Matthew](https://matrix.to/#/@matthew:matrix.org) wrote a response to [https://signal.org/blog/the-ecosystem-is-moving/](https://signal.org/blog/the-ecosystem-is-moving/): [https://matrix.org/blog/2020/01/02/on-privacy-versus-freedom/](https://matrix.org/blog/2020/01/02/on-privacy-versus-freedom/).
...
>
> Full changelog available on GitHub: [https://github.com/tulir/mautrix-telegram/releases/tag/v0.7.0](https://github.com/tulir/mautrix-telegram/releases/tag/v0.7.0)
...
> Install using F-Droid: [https://mtrnord.gitlab.io/fluffychat-flutter-fdroid/fdroid/repo/](https://mtrnord.gitlab.io/fluffychat-flutter-fdroid/fdroid/repo/)
> More info here: [https://www.ko-fi.com/post/FluffyChat-for-Android-and-iOS-S6S71BMEY](https://www.ko-fi.com/post/FluffyChat-for-Android-and-iOS-S6S71BMEY)
...
> I created a [#ping:maunium.net](https://matrix.to/#/#ping:maunium.net) compatible bot in PowerShell [https://gitea.lubiland.de/lub/pingposh/src/branch/master](https://gitea.lubiland.de/lub/pingposh/src/branch/master)
