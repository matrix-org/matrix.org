...
In which Nad & Matthew go through the new consolidated Element roadmap at [https://github.com/vector-im/roadmap/projects/1](https://github.com/vector-im/roadmap/projects/1)

## Dept of *Status of Matrix* 🌡️

### Open Tech Will Save Us 9

Taking place NEXT WEDNESDAY, the ninth edition of my favourite monthly Open Tech-themed live video broadcast! Subscribe to the calendar on [https://matrix.org/open-tech-will-save-us/](https://matrix.org/open-tech-will-save-us/) and check out the lineup:
...
> Still at [https://adoring-einstein-5ea514.netlify.app/](https://adoring-einstein-5ea514.netlify.app/)
>
...
> The Docker ARM images for Dendrite have been updated for version 0.3.2. As always, they can be found in my docker repo at [https://hub.docker.com/u/trslimey](https://hub.docker.com/u/trslimey)
>
> Direct links:
>
>  * Monolith: [https://hub.docker.com/r/trslimey/dendrite-monolith](https://hub.docker.com/r/trslimey/dendrite-monolith)
>  * Polylith: [https://hub.docker.com/r/trslimey/dendrite-polylith](https://hub.docker.com/r/trslimey/dendrite-polylith)
>
...
#### Web
- Element Web 1.7.15-rc.1 is now available at [https://staging.element.io](https://staging.element.io), including
...
> LaTeX support will be available under Labs in the next release of Element: [https://github.com/vector-im/element-web/blob/develop/docs/labs.md](https://github.com/vector-im/element-web/blob/develop/docs/labs.md)
...
> cryptovoxels released a cute little preact matrix client for all your VR needs: [https://github.com/cryptovoxels/chat](https://github.com/cryptovoxels/chat)
