...
So, if you wanted to join the official Scala language support room at [https://gitter.im/scala/center](https://gitter.im/scala/center)
from Matrix, just head over to [#scala_center:gitter.im](https://matrix.to/#/#scala_center:gitter.im) and \*boom\*, you’re in!
