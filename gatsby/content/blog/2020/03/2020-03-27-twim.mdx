...
> The current [http://matrix.to/](http://matrix.to/) link handler is centralized and unfriendly. Before real matrix: URIs are done ([https://github.com/matrix-org/matrix-doc/pull/2312](https://github.com/matrix-org/matrix-doc/pull/2312)), I decided matrix.to needs redesigning, so I've written about it and am working on mock-ups and changes: [https://blog.foad.me.uk/2020/03/24/improving-matrix-to-links/](https://blog.foad.me.uk/2020/03/24/improving-matrix-to-links/) Feedback would be appreciated. Please discuss in [[#matrix.to:matrix.org](https://matrix.to/#/#matrix.to:matrix.org).
...
> You can try it out at [https://ipfs.io/ipns/riot.swedneck.xyz](https://ipfs.io/ipns/riot.swedneck.xyz), or via a local IPFS gateway at http://127.0.0.1:8080/ipns/riot.swedneck.xyz
...
> for those who quite understandably couldn’t endure listening to 90 minutes of waffle about Matrix on The Changelog, the transcript is now up at [https://changelog.com/podcast/384](https://changelog.com/podcast/384)!

## New Public Rooms 🏟

[nico](https://matrix.to/#/@nico:ungleich.ch) said:

> To help people stay in contact in times of coronavirus, there are now coronavirus rooms in 4 languages (German: #covid-19-de:ungleich.ch , English: #covid-19:ungleich.ch, French: #covid-19-fr:ungleich.ch and Korean #covid-19-kr:ungleich.ch) They are all listed on [https://ungleich.ch/u/blog/coronavirus-chats/](https://ungleich.ch/u/blog/coronavirus-chats/) to give new matrix users an easy entrance
