...
> The Changelog invited me to do a podcast on all things Matrix - the 90 minutes of high density braindump can be found over at [https://changelog.com/podcast/384](https://changelog.com/podcast/384)
...
Synapse is now available on OpenBSD from ports. [https://marc.info/?l=openbsd-ports-cvs&m=158368701415531&w=2](https://marc.info/?l=openbsd-ports-cvs&m=158368701415531&w=2)
...
[Paul](https://matrix.to/#/@ptman:kapsi.fi) added this link which krille previously wrote: [https://ko-fi.com/post/FluffyChat-for-Android-and-iOS-S6S71BMEY](https://ko-fi.com/post/FluffyChat-for-Android-and-iOS-S6S71BMEY)

And finally:

> You can find the F-Droid repository at [http://fluffy.chat](http://fluffy.chat)
...
> * Pipeline file for Buildkite is now hosted on another Github repository: [https://github.com/matrix-org/pipelines/blob/master/riotx-android/pipeline.yml](https://github.com/matrix-org/pipelines/blob/master/riotx-android/pipeline.yml)
>
> Other changes:
>
...
>
> Check it out at: [https://github.com/MTRNord/auto-invite-matrix-bot](https://github.com/MTRNord/auto-invite-matrix-bot)
...
> My first [maubot](https://maubot.xyz)! It tracks SARS-COV-2 statistics using data from [https://offloop.net/covid19/](https://offloop.net/covid19/) and was inspired by [BrainstormBot](https://twitter.com/BrainstormBot) on freenode IRC.
>
