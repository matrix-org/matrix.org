...
> I'm working on a Gtk GUI for py-matrix-utils, progress can be followed at [https://gitlab.com/Swedneck/py-matrix-utils](https://gitlab.com/Swedneck/py-matrix-utils)
