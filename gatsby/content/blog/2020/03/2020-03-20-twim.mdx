...
> We are mid in building a team to give free IT support and security help to critical infrastructure operators during Corona times organized via Riot.  Added a local alias for this room here at [#helpeurope:matrix.org](https://matrix.to/#/#helpeurope:matrix.org) . room where we startet creation [#helpeurope:matrix.ctseuro.com](https://matrix.to/#/#helpeurope:matrix.ctseuro.com). Everybody wanting to help is welcome.
