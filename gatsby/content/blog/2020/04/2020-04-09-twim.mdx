...
* [David Dias](https://twitter.com/daviddias) from IPFS IPFS introducing gossipsub in libp2p, including the security hardening work that they've been putting into v1.1!
* [Valère](https://twitter.com/valereonmobile), from Matrix and Riot, who will present the importance of UX and cross-signing keys in end-to-end encrypted communications.
