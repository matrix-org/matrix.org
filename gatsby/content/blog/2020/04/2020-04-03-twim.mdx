...
We'll cover the importance of preserving privacy and ways to keep your communications under control. Read more at [https://matrix.org/open-tech-meetup/](https://matrix.org/open-tech-meetup/)
...
> another release, [https://github.com/matrix-org/sygnal/releases/tag/v0.4.1](https://github.com/matrix-org/sygnal/releases/tag/v0.4.1)
...
>
> [https://mtrnord.gitlab.io/fluffychat-flutter-fdroid/fdroid/repo/](https://mtrnord.gitlab.io/fluffychat-flutter-fdroid/fdroid/repo/)
>
> ### New features
>
> * Voice messages
...
> Hello!  I'm working on a PHP library (GPL v3.0+) that allows to communicate with a Matrix instance.  Currently the library allows to create users, rooms, login to the Matrix server and send messages, although more work needs to be done: [https://github.com/artyom-poptsov/matrix-php](https://github.com/artyom-poptsov/matrix-php)
>
...
>
> More details at [https://github.com/dacruz21/matrix-chart](https://github.com/dacruz21/matrix-chart), and visit [#matrix-chart:typokign.com](https://matrix.to/#/#matrix-chart:typokign.com)  for any questions or support.
...
>
> [https://blog.mozilla.org/blog/2020/03/30/were-fixing-the-internet-join-us/](https://blog.mozilla.org/blog/2020/03/30/were-fixing-the-internet-join-us/)
