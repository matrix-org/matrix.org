...
>
> Url: [https://github.com/progserega/im_sender_service](https://github.com/progserega/im_sender_service)
...
>
> The F-Droid builds still have e2ee. As the play store and fdroid builds use the same build signature, you can simply install the fdroid version over the other one. More information on that here: [https://fluffychat.im/en/fdroid.html](https://fluffychat.im/en/fdroid.html)
>
> #### Features
>
> * Pin and unpin chats
...
>
> * Recording: [https://www.youtube.com/watch?v=3FszhgQSgMM](https://www.youtube.com/watch?v=3FszhgQSgMM)
>
> * Slides: [https://programm.froscon.de/2020/system/event_attachments/attachments/000/000/612/original/presentation.pdf](https://programm.froscon.de/2020/system/event_attachments/attachments/000/000/612/original/presentation.pdf)
