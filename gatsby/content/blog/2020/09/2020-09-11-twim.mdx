...
* Sean DuBois ([Sean-Der](https://matrix.to/#/@sean-der:matrix.org)), WebRTC-knower and author of WebRTC for the Curious discusses his recent work in the space. [https://webrtcforthecurious.com](https://webrtcforthecurious.com)
...
Get the latest: [https://github.com/vector-im/hydrogen-web/](https://github.com/vector-im/hydrogen-web/)

### Element Web

[Neil](https://matrix.to/#/@neilj:matrix.org) (same fellow from earlier) reported:

> Element 1.7.6-rc.1 is now available at [https://staging.element.io](https://staging.element.io):
> 
...
> Getting stuff into the spec or even implemented in Elements is very slow, so while we wait for proper native sticker packs and pickers (i.e. not in an iframe/webview), I decided to make a better sticker picker widget: [https://github.com/maunium/stickerpicker](https://github.com/maunium/stickerpicker)
>
...
>
> ...and the release notes are here: [https://github.com/quotient-im/libQuotient/releases/tag/0.6.1](https://github.com/quotient-im/libQuotient/releases/tag/0.6.1)
...
> [https://publiclist.anchel.nl](https://publiclist.anchel.nl) has been updated. The publiclist contains several public homeservers who can be used freely. Also listed some communities and roomdirectories which can be found at homeservers, last but not least public useable bridges can be found. The homeserver list contains now also uptime percentage and ip info. There is also a json that can be used by client builders.
...
>
> [https://www.youtube.com/watch?v=jTutFZzFizw](https://www.youtube.com/watch?v=jTutFZzFizw)
