...
> [We](https://dsn.tm.kit.edu/) published another scientific paper on Matrix,
>
> this time it is called [Matrix Decomposition: Analysis of an Access Control Approach on Transaction-based DAGs without Finality](https://doi.org/10.1145/3381991.3395399)!
> Its main topic is the question of how access control can work based on a structure
>
> that only provides a partial order on events and no consensus on the current state, i.e. the Matrix Event Graph. We found some concrete, non-critical security issues related to both incorrect specification
...
The papaer was [previously mentioned on the Matrix blog](/blog/2020/06/16/matrix-decomposition-an-independent-academic-analysis-of-matrix-state-resolution).
...
>
>  * We released [1.15.1](https://matrix.org/blog/2020/06/16/synapse-1-15-1-released), this is a bug fix release, sorry if you were bitten. Changelog in full
>
> Bugfixes
>
