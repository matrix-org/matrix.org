...
> * Implementing end-to-end encryption for go-neb turns out to be a lot easier than expected thanks to the [https://github.com/tulir/mautrix](https://github.com/tulir/mautrix) library, which contains out of the box e2ee support!
>
...
> * Code can be found at [https://github.com/nikofil/go-neb/tree/e2ee](https://github.com/nikofil/go-neb/tree/e2ee) until it can be cleaned up
...
Find out more on the project page: [https://github.com/arnav-t/riot-embedded](https://github.com/arnav-t/riot-embedded).
...
> [https://github.com/matrix-org/matrix-static/releases](https://github.com/matrix-org/matrix-static/releases)
>
...
>
> Code: [https://github.com/derEisele/tuple-weather-example](https://github.com/derEisele/tuple-weather-example)
>
...
> [https://github.com/progserega/matrix_redmine_bot](https://github.com/progserega/matrix_redmine_bot)
>
...
> Anyone running a federating instance of Synapse will likely have seen this: Synapse is database-hungry. It tends to take a lot of space. In this post, I'm documenting how I shrunk my homeserver database from 100GB to a little under 8GB, during a long maintenance cleanup. [https://levans.fr/shrink-synapse-database.html](https://levans.fr/shrink-synapse-database.html)
