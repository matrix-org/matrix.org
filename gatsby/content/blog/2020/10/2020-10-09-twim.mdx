...
> This week I worked on a new feature: the Admin Room. This is a room that is
>
> automatically created for the first user of a new homeserver. This room will be
> used to send warnings to server admins in the future and can be used to control
>
> Conduit (like querying information, running cleanup, banning servers, hiding
> public rooms or restarting Conduit). Power levels can be used to control who in
>
> the room has access to which commands. The admin room will work over
> federation, so it's easy to help someone fix his server.
>
> Other news:
>
...
>
> Work on the typescriptification project continues, we are tracking progress [here](https://arewetsyet.bit.ovh/)
>
