...
To get up and running, please install Go and head on over to the Get Started guide at [https://github.com/matrix-org/dendrite#get-started](https://github.com/matrix-org/dendrite#quick-start) to join the fun :)
