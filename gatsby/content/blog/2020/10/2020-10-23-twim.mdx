...
> I built some unofficial Dendrite docker images for Linux/ARM64, for those trying to run Dendrite on a Raspberry Pi, RockPro64 or others. They can be found here: [https://hub.docker.com/r/trslimey/dendrite-monolith](https://hub.docker.com/r/trslimey/dendrite-monolith) & [https://hub.docker.com/r/trslimey/dendrite-polylith](https://hub.docker.com/r/trslimey/dendrite-polylith).
...
> * maaaany bugfixes
>
> You can read about (and run!) the latest release over at [https://github.com/matrix-org/matrix-bifrost/releases/tag/0.2.0-rc1](https://github.com/matrix-org/matrix-bifrost/releases/tag/0.2.0-rc1).
>
...
>
> This week the talk was uploaded! (Norwegian) [https://www.youtube.com/watch?v=s9Xd0Wg_XqA](https://www.youtube.com/watch?v=s9Xd0Wg_XqA)
...
> Jose Franco gave a great talk at AstriCon Plan (9) on building Omnichannel contact centers with Matrix, Asterisk, Kamailio and friends. You can see the video at [https://youtu.be/7S6GZz8f91o?t=18558](https://youtu.be/7S6GZz8f91o?t=18558) and the talk details at [https://astricon2020.sched.com/event/e0GA/blending-open-source-rtc-tools-to-build-an-omnichannel-contact-center](https://astricon2020.sched.com/event/e0GA/blending-open-source-rtc-tools-to-build-an-omnichannel-contact-center)
...
> hey TWIM peeps! we’ve updated the README for our project Noteworthy (matrix powered distributed overlay networks via WireGuard) [https://github.com/decentralabs/noteworthy](https://github.com/decentralabs/noteworthy) - join us over in [#noteworthy:tincan.community](https://matrix.to/#/#noteworthy:tincan.community) with questions / comments!
