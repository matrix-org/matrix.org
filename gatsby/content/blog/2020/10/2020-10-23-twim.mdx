...
>
> Normally there would be a graph here of our MSC progress, however my machine refuses to accept that line graphs are a real thing today. As a replacement, here's the snowfall accumulation graph for Banff as reported by [Environment Canada](https://climate.weather.gc.ca/climate_data/generate_chart_e.html?hlyRange=1997-12-02%7C2020-10-22&dlyRange=1995-04-01%7C2020-10-22&mlyRange=1995-04-01%7C2007-11-01&StationID=27378&Prov=AB&urlExtension=_e.html&searchType=stnProv&optLimit=specDate&StartYear=1840&EndYear=2020&selRowPerPage=25&Line=46&Month=10&Day=22&lstProvince=&timeframe=2&Year=2020&type=bar&MeasTypeID=snow).
...
> I built some unofficial Dendrite docker images for Linux/ARM64, for those trying to run Dendrite on a Raspberry Pi, RockPro64 or others. They can be found here: <https://hub.docker.com/r/trslimey/dendrite-monolith> & <https://hub.docker.com/r/trslimey/dendrite-monolith.>
