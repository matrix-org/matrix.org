...
>
> * Very efficient searching through rooms (custom implementation based on [https://artem.krylysov.com/blog/2020/07/28/lets-build-a-full-text-search-engine/](https://artem.krylysov.com/blog/2020/07/28/lets-build-a-full-text-search-engine/))
>
...
>
> [https://git.sr.ht/~bo41/matrix-channel-mirror](https://git.sr.ht/~bo41/matrix-channel-mirror)
