...
Finally, as of this release Synapse validates ```client_secret``` parameters in the Client-Server API as per the spec. See See [#6766](https://github.com/matrix-org/synapse/issues/6766) for details.
