...
We updated [suggested projects list](http://matrix-org.github.io/gsoc/#/projects) (more to come), so if you're a student please take a loook. Think about what you'd like to work on, get involved with suggested projects, and join [#gsoc:matrix.org](https://matrix.to/#/#gsoc:matrix.org) to discuss.
