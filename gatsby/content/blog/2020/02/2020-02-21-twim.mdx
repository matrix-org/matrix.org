...
Are you interested in a real-life, real-time Matrix-related meetup? Can you make it to London? Join us on the 26th February at Second Home in Spitalfields! Check out the agenda and register at [https://www.eventbrite.com/e/matrix-london-meetup-26th-february-2020-tickets-93320354693](https://www.eventbrite.com/e/matrix-london-meetup-26th-february-2020-tickets-93320354693).
...
> [matrix-discord-parser](https://github.com/matrix-discord/matrix-discord-parser) now utilizes [https://mau.lu/](https://mau.lu/) to neatly bridge inline matrix images {"/"} custom matrix emojis over to discord! mx-puppet-discord already includes the new version.
...
> I made a place where you can post Riot Web themes [https://github.com/aaronraimist/riot-web-themes](https://github.com/aaronraimist/riot-web-themes)
...
Regarding "SSSS", [uhoreg](https://matrix.to/#/@hubert:uhoreg.ca) helpfully links us to [https://github.com/matrix-org/matrix-doc/pull/1946](https://github.com/matrix-org/matrix-doc/pull/1946), and also added:
...
> [https://git.pattle.im/MatMaul/matrix-dart-sdk/tree/moor](https://git.pattle.im/MatMaul/matrix-dart-sdk/tree/moor)
...
>
> [https://github.com/MTRNord/auto-invite-matrix-bot](https://github.com/MTRNord/auto-invite-matrix-bot)
>
...
>
> * GitHub: [https://github.com/dhghf/dad-bot-matrix](https://github.com/dhghf/dad-bot-matrix)
...
> The source is over there: [https://git.sr.ht/~rumpelsepp/remindbot](https://git.sr.ht/~rumpelsepp/remindbot)
