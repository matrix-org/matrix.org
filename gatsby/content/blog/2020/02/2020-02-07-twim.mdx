...
Every month (in theory), we do an in-office wrap-up of some interesting project work from the team. This Matrix Live was recorded this afternoon in the Matrix Office, and features Valere explaining Cross-Signing, and Matthew demonstrating P2P/dendrite.
...
[@stoically:matrix.org](https://matrix.to/#/@stoically:matrix.org) reported:
