...
> [matrix-bot-sdk](https://www.npmjs.com/package/matrix-bot-sdk) has just released v0.5.0 which includes some new helper functions, async storage providers, and a new `SynchronousMatrixClient` for when you *really* need things to happen in a specific order. Check out the diff here: <https://github.com/turt2live/matrix-js-bot-sdk/compare/v0.4.1...v0.5.0>
