...
* **Jay Gruber** ([@arcalinea](https://twitter.com/arcalinea), [@arcalinea:matrix.org](https://matrix.to/#/@arcalinea:matrix.org)), creator of [Happening](https://happening.net/) and [all-around decentralisation fan](https://medium.com/decentralized-web/decentralized-social-networks-e5a7a2603f53) will summarize an overview of the decentralized social media ecosystem that they're working on.
