...
> I have once again updated the Docker ARM Dendrite images for version 0.3.1. These can be found at hub.docker.com/r/trslimey/dendrite-monolith and hub.docker.com/r/trslimey/dendrite-polylith .
...
> Support for receiving EDUs from matrix (typing, read indicators and presence) has been added. Protocol implementations can start using the new events, if they want to. Versoin `0.1.0` has been released along with this. You have to enable the `de.sorunome.msc2409.push_ephemeral` flag in your registration file
>
> #### mx-puppet-discord
>
