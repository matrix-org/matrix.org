...
Element Web 1.7.17-rc.1 is now available at [https://staging.element.io](https://staging.element.io), including:
...
>
> For the progress you can also take a look at [https://github.com/keymaker-mx/keymaker/projects/1]https://github.com/keymaker-mx/keymaker/projects/1
>
> Check the current page out at: [https://homeservers.mx](https://homeservers.mx) [https://joinmatrix.rocks/](https://joinmatrix.rocks/)
>
> Join development and discussions at [#serverlist:nordgedanken.dev](https://matrix.to/#/#serverlist:nordgedanken.dev)
> Check out the Code at: [https://github.com/keymaker-mx](https://github.com/keymaker-mx)
