...
> moderator, but there is not much activity in your room because it doesn't have
>
> enough users?
>
...
*   Spaces:
    *   Drag and drop for reordering Spaces is now live on Android! And testable on [develop](develop.element.io) for Web
