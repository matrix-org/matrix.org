...
> Hi everyone! Did you ever feel lost in the Matrix world? The room directory is
>
> big, but it's still hard to find something you like. Or are you a room
...
> Hello! The last two weeks I mostly tried to make our database backend swappable
>
> so we don't need to rely on the sled database anymore. I was able to try out
> rocksdb, but there were bugs in the rust bindings which required inefficient
>
...
> If you live in France (or eurozone) and your Matrix-related project need some funds, you may candidate to the 2021 #MécénatCodeLutin grant program for FLOSS by [Code Lutin](https://www.codelutin.com/). Canditates may fill the [dedicated form](https://framaforms.org/mecenat-code-lutin-2021-1620296813) before july 8th.
