...
>
> The source is in only available in German, unfortunately: [https://zenodo.org/record/4817795](https://zenodo.org/record/4817795)
>
...
> Here's your weekly spec update! The heart of Matrix is the specification - and this is modified by Matrix Spec Change (MSC) proposals. Learn more about how the process works at [https://spec.matrix.org/unstable/proposals](https://spec.matrix.org/unstable/proposals).
>
>
> #### MSC Status
>
...
> Issue page: [https://src.miscworks.net/fair/matrix-puppeteer-line/issues](https://src.miscworks.net/fair/matrix-puppeteer-line/issues)
...
> 
> - We used fluent for translations. [https://lily.kazv.moe/kazv/kazv/-/merge_requests/1](https://lily.kazv.moe/kazv/kazv/-/merge_requests/1)
> - We supported read and save client state. [https://lily.kazv.moe/kazv/kazv/-/merge_requests/2](https://lily.kazv.moe/kazv/kazv/-/merge_requests/2)
