...
Another recent GroupMe bridge effort: [https://gitlab.com/robintown/mx-puppet-groupme](https://gitlab.com/robintown/mx-puppet-groupme)
...
>
> [libkazv-doc]: [https://mxc.kazv.moe/libkazv/index.html](https://mxc.kazv.moe/libkazv/index.html)
>
> 2. Together with that, added a ["getting started" guide with an example][getting-started] {">"}w{"<"}
>
> [getting-started]: [https://gitlab.com/kazv/libkazv/-/blob/servant/tutorials/tutorial0.md](https://gitlab.com/kazv/libkazv/-/blob/servant/tutorials/tutorial0.md)
>
> 3. Made matrix-tencent-forward-bot support [directly forwarding images][img-fwd]
>
>    *from* the matrix room.
>
> [img-fwd]: [https://gitlab.com/kazv/matrix-tencent-forward-bot/-/commit/68e5274f07886e93035adedaca495d762a69ba38](https://gitlab.com/kazv/matrix-tencent-forward-bot/-/commit/68e5274f07886e93035adedaca495d762a69ba38)
>
> 4. [Colourized sender nicks][col-nick] in messages for matrix-tencent-forward-bot.
>
> [col-nick]: [https://gitlab.com/kazv/matrix-tencent-forward-bot/-/commit/4b03a3349d8dc7179988f3d4af68277a6bc7ac68](https://gitlab.com/kazv/matrix-tencent-forward-bot/-/commit/4b03a3349d8dc7179988f3d4af68277a6bc7ac68)
...
> I am very excited to launch Cactus Comments ([https://cactus.chat](https://cactus.chat)) today together with @asbjorn:olli.ng!
>
...
>
> Read the introductory blog post: [https://cactus.chat/blog/hello-cactus-comments/](https://cactus.chat/blog/hello-cactus-comments/)
> Try the demo: [https://cactus.chat/demo/](https://cactus.chat/demo/)
>
> Source code: [https://gitlab.com/cactus-comments](https://gitlab.com/cactus-comments)
...
>
> [https://github.com/hummingbard/hummingbard](https://github.com/hummingbard/hummingbard)
