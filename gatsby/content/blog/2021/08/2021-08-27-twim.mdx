...
> [https://github.com/alphapapa/ement.el](Ement.el), a Matrix client for Emacs, gained some more improvements this week:
>
...
> * Encrypted rooms now display a warning in the header and suggest that users consider using [https://github.com/matrix-org/pantalaimon/](Pantalaimon).
>
...
![2021-08-27-mS530-Showingthenew"hotness"timestampswiththedoom-onetheme.](/blog/img/2021-08-27-mS530-Showingthenew"hotness"timestampswiththedoom-onetheme.)
...
* Notifications setting will be updated in the next release, with the ability to get notified when keywords are including in any message (only on un-encrypted rooms for now)
...
>
> * Event relations: These used to be serialize wrongly for encrypted events and were only (de)serializable as part of a larger event (making using them in custom ways impossible). Both of these issues were fixed.
>
