...
> _synadm_ is growing! Pull requests have been submitted, issues been raised, bugs fixed and quite some user community seems to have evolved around it as it’s regularily mentioned on [#synapse:matrix.org](https://matrix.to/#/#synapse:matrix.org)
>
