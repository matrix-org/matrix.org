...
_This is the first of three posts on improving type coverage in Sydent. Join us next Friday for the second part!_
...
In this first part, we'll concentrate on the first two topics; the [second](https://matrix.org/blog/2021/12/10/type-coverage-for-sydent-annotation) covers the middle two; and the third the last two.
