...
In a series of posts, I'd like to reflect on this sprin and share what we've learned. In particular, I aim to:
...
In this first part, we'll concentrate on the first two topics.
...
Unfortunately it'd be a pain to annotate our application code to mark every use of `IResponse.headers` as a `Headers` object. We'll see a better way to do things in this [the next post](2021-11-XX-sydent-typing-2.mdx), which discusses the core process of adding annotating.
