...
In this first part, we'll concentrate on the first two topics; the [second](2021-11-XX-sydent-typing-2.mdx) covers the middle two; and the [third](2021-11-XX-sydent-typing-3.mdx) the last two.
...
Unfortunately it'd be a pain to annotate our application code to mark every use of `IResponse.headers` as a `Headers` object. We'll see a better way to do things in this [the next post](2021-11-XX-sydent-typing-2.mdx), which discusses the nitty-gritty details of adding annotations file-by-file.
