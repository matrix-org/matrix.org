...
This release also brings Synapse closer to compatiblity with [Matrix v1.1](https://matrix.org/blog/2021/11/09/matrix-v-1-1-release) by adding support for the `/_matrix/client/v3` and `/_matrix/media/v3` APIs from the latest version of the specification.
