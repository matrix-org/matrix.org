...
On **Tuesday, 23rd November** we plan to release Synapse 1.47.1 to address a single high severity issue. Synapse is a Matrix homeserver implementation developed by the matrix.org team and the wider Matrix community.
