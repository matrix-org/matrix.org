...
Instructions on installing Synapse can be found in the [Synapse documentation website](https://matrix-org.github.io/synapse/latest/setup/installation.html).
