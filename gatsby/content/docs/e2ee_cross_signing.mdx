...
4. If you are doing the first verification with an own device you don't have any cross-signing keys
   ...
   how you can detect wether you should do this behaviour - for now you could only sign other own
...
You could re-use the same recursive method to determine if a device is verified as previously imlemented,
