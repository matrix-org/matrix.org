...
<p>To host your own <a href="#definition-homeserver" class="definition">homeserver</a> you can download and run one of the available Matrix servers - please see <a href="/docs/guides/getting_involved.html#run">this guide</a> for details!</p>
...
<p>The Matrix Specification describes and prescribes the interaction between <a href="#definition-client" class="definition">clients</a>, <a href="#definition-homeserver">servers</a>, <a href="/docs/guides/application_services.html">Application Services</a> and more.</p>
