...
![Basic architecture of Synapse deployment with docker compose](/docs/guides/img/understanding-synapse-hosting-architecture.png "Basic architecture of Synapse deployment with docker compose")
...
Internet at all. It can only be accessed from withing the docker network. While
...
![Synapse serving its static page, behind nginx](/docs/guides/img/understanding-synapse-hosting-nginx.png "Synapse serving its static page, behind nginx")
