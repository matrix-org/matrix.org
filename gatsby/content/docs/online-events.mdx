...
installation at [https://jitsi.modular.im](https://jitsi.modular.im).
...
[https://stream.matrix.org](https://stream.matrix.org)) which contains ONLY the video, then create a
