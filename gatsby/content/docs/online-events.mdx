...
Jitsi itself comes with the ability to stream to YouTube, but only YouTube. An open-source
...
to use a [Javascript player like Google's shaka playe](https://github.com/google/shaka-player).
