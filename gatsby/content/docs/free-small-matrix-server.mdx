...
- 3478/tcp, 5349/tcp, 3478/udp, 5349/udp, 49152-49172/udp for TURN/STUN (this is
  used to get through firewalls or NAT for 1-on-1 audio/video calls and can be
  omitted)
...
matrix_coturn_enabled: true # disable to save more RAM, enables NAT/firewall
                            # traversal for 1-on-1 audio/video calls
```

### Configure the public IP address for coturn

Optional if you want to provide NAT/firewall traversal for 1-to-1 audio/video
calls.
