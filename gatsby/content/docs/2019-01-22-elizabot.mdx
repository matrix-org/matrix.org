...
available online through a web interface: [https://www.masswerk.at/elizabot/](https://www.masswerk.at/elizabot/).
...
That all the code needed to get a working version of the bot running. If you look at [https://github.com/benparsons/elizabot](https://github.com/benparsons/elizabot), you can find a simple implementation as described here in `simple.js`, and a more robust implementation in `index.js`.
