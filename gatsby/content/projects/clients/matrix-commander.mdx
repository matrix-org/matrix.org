...
categories:
 - client
description: Simple CLI-based Matrix client for sending and receiving with support for end-to-end encryption and emoji verification
author: 8go
home: https://github.com/8go/matrix-commander
language: Python 3 (matrix-nio SDK)
...
maturity: Late Beta # Options are: Released, Stable, Late Beta, Beta, Early Beta, Late Alpha, Alpha, Early Alpha, or Not actively maintained
---
