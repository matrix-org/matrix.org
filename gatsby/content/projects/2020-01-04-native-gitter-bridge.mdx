...
If you're curious about the bridge, there is a great overview of the capabilities and future plans in [this Matrix.org blog post](https://matrix.org/blog/2020/12/07/gitter-now-speaks-matrix).

![](/docs/projects/images/gitter-bridge-demo.gif)
