...
The native iOS version of the [Riot](/docs/projects/client/riot) web client. Riot iOS is a glossy client with focus on performance and usability.
...
You can help test the beta version of Riot on [TestFlight](https://testflight.apple.com/join/lCeTuDKM).
