...
NeoChat was born as a Spectral fork. It uses [Kirigami](https://develop.kde.org/frameworks/kirigami/) to provide a convergent user interface between desktop (Plasma, GNOME and other desktops and Windows) and mobile (Plasma Mobile and Android).
